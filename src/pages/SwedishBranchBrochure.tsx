...
export function SwedishBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Swedish tax authorities',
    ...
    },
    {
      ...
      description:
        'File annual financial statements with the Swedish Companies Registration Office (Bolagsverket)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign parent company; no separate legal person',
      subsidiary: 'Separate Swedish legal entity (e.g., Aktiebolag - AB)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable for branch obligations',
      subsidiary: 'Liability limited to subsidiary\'s assets',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirements',
      branch: 'None',
      subsidiary: 'Minimum SEK 25,000 for a private limited company',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Swedish operations; parent company liable',
      subsidiary: 'Taxed on worldwide income as an independent entity',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Registration at Bolagsverket; simpler formalities',
      subsidiary: 'Incorporation including notarized documents; complex setup',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Swedish regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Swedish business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Swedish business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Swedish branch company?',
      answer:
        'A Swedish branch (filial) is not a separate legal entity but an extension of your existing foreign company in Sweden. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Sweden with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Swedish branch vs. a subsidiary?',
      answer:
        'The main advantages of a Swedish branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Swedish branch?',
      answer:
        'Yes, a Swedish branch requires a managing director who must be resident in the European Economic Area (EEA) or you must apply for exemption. The managing director must have special authorization and a power of attorney to represent the branch. This is different from other countries where branches don\'t require local directors.',
    },
    {
      question: 'What activities can a Swedish branch perform?',
      answer:
        'A Swedish branch can perform all the same activities as a Swedish legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Swedish branch own property and enter into contracts?',
      answer:
        'Yes, a Swedish branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Sweden?',
      answer:
        "A Swedish branch is taxed on Swedish operations, with the parent company liable for the tax obligations. The branch keeps separate accounting records and files annual financial statements in Sweden. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Swedish branch will need to comply with: 1) Annual financial statement filing with the Swedish Companies Registration Office (Bolagsverket), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities. Branches with more than three employees or turnover exceeding specified thresholds require audited accounts.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Swedish business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Sweden Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Sweden with a flexible,
      ...
      {/* What is a Swedish Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Swedish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Swedish branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Swedish branch (filial) is a permanent establishment of a foreign company conducting business in Sweden, but it is not a separate legal entity. It operates as part of the parent company, which retains full liability for the branch's activities and obligations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Swedish branch can perform all the same business activities as a Swedish legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct economic activities authorized to the parent company in Sweden and the EU',
                  'Enter contracts and business relationships under Swedish law',
                  'Own or lease property and assets locally',
                  'Employ staff under Swedish labor regulations',
                  'Open Swedish bank accounts',
                  'Register for VAT and corporate taxes for local operations',
                  'Obtain necessary licenses and permits',
                  'Engage in government contracts and public tenders',
              ...
              <p className="text-blue-100 mb-6">
                To establish a branch, the foreign company must appoint a managing director resident in the European Economic Area (EEA) or apply for exemption. The branch must register with the Swedish Companies Registration Office (Bolagsverket) using specified forms along with apostilled and translated corporate documents including certificate of incorporation and articles of association. The managing director must have special authorization and a power of attorney to represent the branch. Branches with more than three employees or turnover exceeding specified thresholds require audited accounts. The branch keeps separate accounting records and files annual financial statements in Sweden.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Sweden
              </p>
            </div>
      ...
      {/* About Swedish Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Swedish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Sweden
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Sweden\'s competitive tax environment',
                    'Access to Sweden\'s highly skilled and multilingual workforce',
                    'Strategic gateway to Nordic and Baltic markets',
                    'Access to Sweden\'s world-class innovation ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Companies expanding to Nordic and Baltic markets',
                    'Service providers testing the Swedish market before full commitment',
                    ...
                    "Startups seeking to leverage Sweden's business-friendly environment",
                    'Companies targeting the Nordic and Baltic markets',
                    'Tech and innovation businesses',
                    'Organizations requiring access to Sweden\'s skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Swedish branch registration process typically takes 4-6 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and Bolagsverket registration
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Swedish branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Swedish branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Swedish branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Swedish branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Swedish branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Swedish Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Swedish branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Swedish business experts on
              WhatsApp:{' '}
            </span>
            <a
