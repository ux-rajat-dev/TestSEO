...
export function RomanianBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Romanian tax authorities',
    ...
    },
    {
      ...
      description:
        'File annual financial statements with the National Trade Register Office (ONRC)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign company; no separate legal entity',
      subsidiary: 'Separate Romanian legal entity (e.g. SRL)',
    ...
    },
    {
      ...
      subsidiary: 'Minimum capital required (e.g., RON 200 for SRL)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Romanian-sourced income at 16% corporate tax',
    ...
    },
    {
      ...
      branch: 'Moderate; requires registration with ONRC and document filings',
      subsidiary: 'More complex; formal incorporation process',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Romanian regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Romanian business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Romanian business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Romanian branch company?',
      answer:
        'A Romanian branch is not a separate legal entity but an extension of your existing foreign company in Romania. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Romania with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Romanian branch vs. a subsidiary?',
      answer:
        'The main advantages of a Romanian branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Romanian branch?',
      answer:
        'No, a Romanian branch does not require a local Romanian director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local legal representative who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Romanian branch perform?',
      answer:
        'A Romanian branch can perform all the same activities as a Romanian legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Romanian branch own property and enter into contracts?',
      answer:
        'Yes, a Romanian branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Romania?',
      answer:
        "A Romanian branch pays corporate income tax at 16% on profits derived in Romania. It is required to maintain local accounting records and file annual tax returns. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Romanian branch will need to comply with: 1) Annual financial statement filing with the National Trade Register Office (ONRC), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Romanian business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Romania Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Romania with a flexible,
      ...
      {/* What is a Romanian Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Romanian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Romanian branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Romanian branch is a permanent establishment of a foreign company and does not have its own legal personality. It functions as an extension of the parent company, which is fully liable for the branch's obligations and liabilities.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Romanian branch can perform all the same business activities as a Romanian legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct the same type of business activities authorized to the parent company in Romania and the EU',
                  'Enter into contracts and legal agreements on behalf of the parent company',
                  'Own or lease assets and property within Romania',
                  'Employ staff compliant with Romanian labor laws',
                  'Open local bank accounts for operational needs',
                  'Register for VAT and corporate tax obligations as per Romanian tax law',
                  'Obtain necessary licenses, permits, and comply with local regulatory requirements',
              ...
              <p className="text-blue-100 mb-6">
                Registration requires submitting a special declaration, notarized decision of the foreign parent company, proof of registered office in Romania, and appointment of a legal representative. All documents must be apostilled and translated into Romanian. The branch is registered with the National Trade Register Office (ONRC). The branch name must match the parent company's name. The parent company bears full liability and all branch activities must comply with Romanian law.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                The branch pays corporate income tax at 16% on profits derived in Romania. It is required to maintain local accounting records and file annual tax returns.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Romania
              </p>
            </div>
      ...
      {/* About Romanian Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Romanian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Romania
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Romania\'s competitive 16% corporate tax rate',
                    'Access to Romania\'s large and skilled workforce',
                    'Strategic gateway to Eastern European markets',
                    'Access to Romania\'s growing tech and manufacturing ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Companies expanding to Eastern European markets',
                    'Service providers testing the Romanian market before full commitment',
                    ...
                    "Startups seeking to leverage Romania's business-friendly environment",
                    'Companies targeting the Eastern European markets',
                    'Manufacturing and industrial businesses',
                    'Organizations requiring access to Romania\'s skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Romanian branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and ONRC registration
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Romanian branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Romanian branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Romanian branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Romanian branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Romanian branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Romanian Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Romanian branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Romanian business experts on
              WhatsApp:{' '}
            </span>
            <a
