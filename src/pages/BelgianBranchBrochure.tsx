...
export function BelgianBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Belgian tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Crossroads Bank for Enterprises (BCE/CBE)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      ...
      subsidiary: 'Independent Belgian legal entity (usually SRL/BV)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable',
      subsidiary: 'Limited to the subsidiary\'s share capital',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirements',
      branch: 'No minimum capital requirement',
      subsidiary: 'Minimum capital of €1 for SRL (formerly SPRL)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Repatriation',
      branch: 'No dividend withholding tax on branch profits',
      subsidiary: 'Dividends may be subject to 15–25% withholding tax',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; requires translations, BCE registration, and gazette publication',
      subsidiary: 'Higher; requires notarial deed of incorporation and registration',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Belgian regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Belgian business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Belgian business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Belgian branch company?',
      answer:
        'A Belgian branch is not a separate legal entity but an extension of your existing foreign company in Belgium. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Belgium with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Belgian branch vs. a subsidiary?',
      answer:
        'The main advantages of a Belgian branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Belgian branch?',
      answer:
        'No, a Belgian branch does not require a local Belgian director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a branch representative who is authorized to act on behalf of the branch in Belgium.',
    },
    {
      question: 'What activities can a Belgian branch perform?',
      answer:
        'A Belgian branch can perform all the same activities as a Belgian legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Belgian branch own property and enter into contracts?',
      answer:
        'Yes, a Belgian branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Belgium?',
      answer:
        "A Belgian branch is subject to Belgian corporate income tax on profits attributable to its activities in Belgium. However, unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. The standard corporate tax rate is 25% on taxable profits.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Belgian branch will need to comply with: 1) Annual financial statement filing with the Crossroads Bank for Enterprises (BCE/CBE), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Belgian business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Belgium Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Belgium with a flexible,
      ...
      {/* What is a Belgian Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Belgian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Belgian branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Belgian branch is a permanent establishment of a foreign company, not a separate legal entity. It functions as an extension of the parent company, which retains legal and financial responsibility for its actions.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Belgian branch can perform all the same business activities as a Belgian legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct business operations and trade within Belgium and across the EU',
                  'Enter into contracts and business agreements under Belgian law',
                  'Own or lease assets, including offices or property',
                  'Employ staff under Belgian labor regulations',
                  'Open local bank accounts',
                  'Register for VAT and corporate tax purposes',
                  'Apply for necessary business permits and regulatory approvals',
                  'Participate in public and government tenders',
              ...
              <p className="text-blue-100">
                The parent company remains fully liable for branch obligations, debts, and contracts. The branch must file specific documents—including notarized statutes, board resolutions, and financial statements—translated into French, Dutch, or German, based on the region of registration. Registration occurs through the Commercial Court and Crossroads Bank for Enterprises (BCE/CBE), followed by publication in the Moniteur Belge.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Belgium
              </p>
            </div>
      ...
      {/* About Belgian Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Belgian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Belgium
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Leverage Belgium's strategic location at the heart of Europe",
                    'Access to Belgium\'s multilingual workforce (French, Dutch, German)',
                    'Benefit from Belgium\'s extensive transport infrastructure',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to the European market',
                    'Service providers testing the Belgian market before full commitment',
                    ...
                    "Startups seeking to leverage Belgium's business-friendly environment",
                    'Companies targeting the Benelux region (Belgium, Netherlands, Luxembourg)',
                    'Organizations requiring multilingual business operations',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Belgian branch registration process typically takes 7-9 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and translation into French, Dutch, or German
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, BCE registration, and Moniteur Belge publication
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <div className="text-[#EA3A70] font-semibold">Weeks 8-9</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Belgian branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Belgian branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Belgian branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Belgian branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Belgian branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Belgian Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Belgian branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Belgian business experts on
              WhatsApp:{' '}
            </span>
            <a
