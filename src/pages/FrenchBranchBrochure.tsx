...
export function FrenchBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the French tax authorities',
    ...
    },
    {
      ...
      description:
        'File consolidated financial statements with the French Commercial Court (RCS)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      ...
      subsidiary: 'Separate French legal entity (SARL, SAS, SA)',
    ...
    },
    {
      ...
      branch: 'None',
      subsidiary: 'Required based on entity type (e.g., SARL minimum €1)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Taxation',
      branch: 'Taxed on French profits at ~25% corporate tax',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all French regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about French business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of French business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a French branch company?',
      answer:
        'A French branch (succursale) is not a separate legal entity but an extension of your existing foreign company in France. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in France with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a French branch vs. a subsidiary?',
      answer:
        'The main advantages of a French branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my French branch?',
      answer:
        'No, a French branch does not require a local French director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a branch manager or legal representative residing in France who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a French branch perform?',
      answer:
        'A French branch can perform all the same activities as a French legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a French branch own property and enter into contracts?',
      answer:
        'Yes, a French branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in France?',
      answer:
        "A French branch is taxed on profits generated in France at the French corporate tax rate of approximately 25%. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. Social contributions apply to employee wages locally.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your French branch will need to comply with: 1) Annual financial statement filing with the French Commercial Court (RCS), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to French business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              France Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to France with a flexible,
      ...
      {/* What is a French Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a French Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the French branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A French branch (succursale) is a permanent establishment of a foreign company, not a separate legal entity, acting as an extension of the parent company. The parent company is fully liable for all the branch's contractual obligations and debts.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A French branch can perform all the same business activities as a French legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Operate commercial activities in France and throughout the EU',
                  'Enter contracts and business relationships under French law',
                  'Own or lease premises and assets locally',
                  'Employ staff according to French labor regulations',
                  'Open French bank accounts for branch operations',
              ...
              <p className="text-blue-100 mb-6">
                To open a branch in France, the foreign company must file notarized and translated documents (Articles of Association, Board resolution, certificate of incorporation) with the French Commercial Court (Registre du Commerce et des Sociétés - RCS). A branch manager or legal representative residing in France must be appointed. The branch is assigned a unique SIRET number and must publish a legal announcement in a Journal d'Annonces Légales.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100 mb-6">
                The branch is taxed on profits generated in France at the French corporate tax rate (~25%). Social contributions apply to employee wages locally. Tax treaties may modify tax liability, especially for preparatory or auxiliary activities.
              </p>
              <h3 className="text-2xl font-bold mb-4">Costs</h3>
              <p className="text-blue-100">
                Costs of setting up a branch typically range from €1,500 to €3,000, covering legal, translation, publication, and registration fees.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in France
              </p>
            </div>
      ...
      {/* About French Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a French Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in France
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from France\'s ~25% corporate tax rate',
                    'Access to France\'s large and sophisticated market',
                    'Strategic gateway to French-speaking African markets',
                    'Access to France\'s world-class infrastructure and talent',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Companies expanding to the French market',
                    'Service providers testing the French market before full commitment',
                    ...
                    "Startups seeking to leverage France's business-friendly environment",
                    'Companies targeting the French-speaking African markets',
                    'Luxury and fashion businesses',
                    'Organizations requiring access to France\'s innovation ecosystem',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The French branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, translation, and RCS registration
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Legal announcement publication and receipt of SIRET number
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 6-8</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for French branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your French branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your French branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying French branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about French branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your French Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive French branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our French business experts on
              WhatsApp:{' '}
            </span>
            <a
