...
const COUNTRY_DATA = {
  netherlands: {
    ...
    benefits: [
      'Fast registration process (3-5 days)',
      'Minimal capital requirement (€0.01)',
    ...
    requirements: [
      'Valid passport/ID for all directors',
  ...
  germany: {
    ...
    color: '#003E6B',
    processingTime:
      '10-20 business days (can be 2-3 weeks with complete documents)',
    complexity: 'Moderate',
    capitalRequirement:
      '€1 (UG/mini-GmbH), €25,000 (standard GmbH), €50,000 (AG)',
    registrationFee:
      '€500-€2,000 (variable, plus notary and legal support if required)',
    mainEntityType: 'GmbH (Private Limited Company)',
    secondaryEntityType:
      'UG (Entrepreneurial Company), AG (Public Company), Branch Office',
    benefits: [
    ...
    entityStructures: [
      {
        ...
        description:
          'Most popular limited liability company for German and foreign founders',
      ...
      },
      {
        ...
        description:
          'Limited liability, minimum capital, designed for startups',
      ...
      },
      {
        ...
        description:
          'Public limited company, suitable for larger businesses seeking capital markets',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of a foreign company, no separate legal identity',
  ...
  france: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€1 (SARL/SAS), €37,000 (SA, with 1/5th at registration)',
    registrationFee:
      '€65-€250 (Trade Register), legal support/services extra (typically €800-€1,000+)',
    mainEntityType:
      'SARL (Private Limited Company), SAS (Simplified Joint Stock Company), SA (Public Limited Company)',
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common SME structure, suitable for entrepreneurs and small businesses',
      ...
      },
      {
        ...
        description:
          'Flexible structure for larger businesses, often for holding companies and startups',
      ...
      },
      {
        ...
        description:
          'Intended for large businesses planning to raise capital or go public',
      ...
      },
      {
        ...
        description:
          'For marketing and research, cannot trade/commercial activity',
        capitalRequirement: 'None',
        timeline: '1 week',
        liability: 'Parent company fully liable',
  ...
  spain: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum €3,000 (SL - Sociedad Limitada), €60,000 (SA - Sociedad Anónima)',
    registrationFee: 'Approx. €100-€300, plus legal and notary fees (varies)',
    mainEntityType:
      'SL (Limited Liability Company), SA (Public Limited Company)',
    ...
    statistics: {
      ...
      corporateTax:
        '25% (standard), reduced rates for SMEs (15%) on initial profits',
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'For larger businesses seeking capital and stock market presence',
  ...
  italy: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€1 (SRL - Private Limited Company), €50,000 (SPA - Public Limited Company)',
    registrationFee: 'Approx. €200-€600 plus notary and legal fees (varies)',
    mainEntityType:
      'SRL (Società a Responsabilità Limitata), SPA (Società per Azioni)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Impresa Individuale)',
    benefits: [
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common company type, limited liability, flexible for SMEs',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign company without separate legal entity status',
        capitalRequirement: 'None',
        timeline: '1-2 weeks',
  ...
  belgium: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum €18,550 (Private Limited Company - BV/SRL), €61,500 (Public Limited Company - NV/SA)',
    registrationFee: '€87-€207 plus notary and official fees',
    mainEntityType:
      'BV (Besloten Vennootschap/Private Limited Company), NV (Naamloze Vennootschap/Public Limited Company)',
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common company type since reform, flexible and limited liability',
        capitalRequirement:
          'Minimum €18,550 (flexible), commonly fully paid at setup',
        timeline: '1-2 weeks',
        liability: 'Limited to capital contribution',
        suitableFor: 'SMEs, startups, family businesses',
      },
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign company with no separate legal identity',
        capitalRequirement: 'None',
        timeline: '1 week',
        liability: 'Parent company liable',
  ...
  ireland: {
    ...
    secondaryEntityType:
      'Public Limited Company (PLC), Branch Office, Sole Trader',
    benefits: [
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common type for SMEs and startups, limited liability',
      ...
      },
      {
        ...
        description:
          'Suitable for larger companies or those seeking to trade publicly',
  ...
  austria: {
    ...
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Einzelunternehmen)',
    benefits: [
    ...
    entityStructures: [
      {
        name: 'GmbH (Private Limited Company)',
        description:
          'Most common and flexible company form with limited liability',
        capitalRequirement:
          'Minimum €35,000 (at least €17,500 paid upon registration)',
        timeline: '1-3 weeks',
        liability: 'Limited to share capital',
      ...
      },
      {
        ...
        description:
          'Suitable for larger companies and stock market participants',
        capitalRequirement:
          'Minimum €70,000, with 25% minimum paid at registration',
        timeline: '2-4 weeks',
        liability: 'Limited to share capital',
        suitableFor: 'Large enterprises',
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign parent company without independent legal identity',
        capitalRequirement: 'None',
        timeline: '1-2 weeks',
        liability: 'Parent company liable',
  ...
  bulgaria: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum BGN 2 (€1 approximately) for LLC (OOD), BGN 50,000 for Joint Stock Company (AD)',
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for larger enterprises needing to raise capital publicly or privately',
  ...
  croatia: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'HRK 10,000 (€1,300 approx.) for d.o.o. (Limited Liability Company), HRK 200,000 (€26,500 approx.) for d.d. (Joint Stock Company)',
    registrationFee:
      'Approximately HRK 400-1,200 (€50-160) depending on company type',
    mainEntityType:
      'd.o.o. (Društvo s Ograničenom Odgovornošću - Limited Liability Company), d.d. (Dioničko Društvo - Joint Stock Company)',
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common structure, limited liability, suitable for SMEs',
      ...
      },
      {
        ...
        description:
          'For larger companies, able to raise capital through shares publicly or privately',
  ...
  cyprus: {
    ...
    complexity: 'Low to Moderate',
    capitalRequirement:
      'Minimum €1,000 (Private Limited Company); €25,629 (Public Limited Company)',
    ...
    entityStructures: [
      {
        ...
        description:
          'Most common form for businesses in Cyprus; limited liability',
      ...
      },
      {
        name: 'Public Limited Company (PLC)',
        description:
          'Suitable for larger businesses and those seeking public funding',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign parent with no separate legal personality',
        capitalRequirement: 'None',
        timeline: '3-5 days',
        liability: 'Parent company fully liable',
        suitableFor: 'Market presence and testing',
  ...
  czech: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'CZK 1 (€40 approx.) for s.r.o. (Limited Liability Company), CZK 2,000,000 (€80,000 approx.) for a.s. (Joint Stock Company)',
    registrationFee: 'Approx. CZK 6,000-7,000 (~€240-280)',
    mainEntityType:
      's.r.o. (Společnost s ručením omezeným - Limited Liability Company), a.s. (Akciová společnost - Joint Stock Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Živnostenský podnikatel)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        name: 'Branch Office',
        description:
          "Foreign company's branch without separate legal entity status",
  ...
  denmark: {
    ...
    complexity: 'Low',
    capitalRequirement:
      'DKK 40,000 (€5,400 approx.) for ApS (Private Limited), DKK 500,000 (€67,000 approx.) for A/S (Public Limited Company)',
    registrationFee: 'Approx. DKK 670-2,900 (€90-390)',
    mainEntityType:
      'ApS (Anpartsselskab - Private Limited Company), A/S (Aktieselskab - Public Limited Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Enkeltmandsvirksomhed)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for large companies or those wanting to list shares',
  ...
  estonia: {
    ...
    complexity: 'Low',
    capitalRequirement:
      'Minimum €2,500 for OÜ (Private Limited Company); Public Limited Company (AS) requires more capital',
    registrationFee: 'Approx. €190 online, higher for paper submissions',
    mainEntityType:
      'OÜ (Osaühing - Private Limited Company), AS (Aktsiaselts - Public Limited Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (FIE - Füüsilisest Isikust Ettevõtja)',
    benefits: [
    ...
    entityStructures: [
      {
        ...
        capitalRequirement:
          'Minimum €2,500 (can be deferred with certain conditions)',
        timeline: '1-3 days',
        liability: 'Limited to share capital',
  ...
  finland: {
    ...
    color: '#003580',
    processingTime:
      '1-4 weeks depending on company type and document readiness',
    complexity: 'Low to Moderate',
    capitalRequirement:
      'Minimum €1 for private limited company (Oy); €80,000 for public limited company (Oyj)',
    registrationFee: 'Approx. €275 for online registration (private company)',
    mainEntityType:
      'Oy (Osakeyhtiö - Private Limited Company), Oyj (Julkinen Osakeyhtiö - Public Limited Company)',
    secondaryEntityType:
      'Branch Office (Sivuliike), Representative Office (Edustusto), Sole Proprietorship (Toiminimi)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for larger enterprises and companies listing on stock exchanges',
  ...
  greece: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum €4,500 for IKE (Private Company), €25,000 for AE (Public Limited Company)',
    registrationFee:
      'Approx. €200-€500 depending on company type and legal fees',
    mainEntityType:
      'IKE (Ιδιωτική Κεφαλαιουχική Εταιρεία - Private Company LLC equivalent), AE (Ανώνυμη Εταιρεία - Public Limited Company)',
    secondaryEntityType:
      'LTD (Εταιρεία Περιορισμένης Ευθύνης- EPE), Sole Proprietorship (Ατομική Επιχείρηση)',
    benefits: [
    ...
    entityStructures: [
      {
        ...
        capitalRequirement:
          'Minimum €4,500, often lower or flexible with amendments',
        timeline: '7-15 days',
      ...
      },
      {
        ...
        description:
          'Larger company, suited for stock issuance and public investments',
        capitalRequirement: 'Minimum €25,000',
        timeline: '14-21 days',
        liability: 'Limited to share capital',
        suitableFor: 'Large companies',
  ...
  hungary: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'HUF 3,000,000 (€8,000 approx.) for Kft (Limited Liability Company); HUF 5,000,000 (€13,000 approx.) for Rt (Public Limited Company)',
    registrationFee: 'Approx. HUF 50,000-60,000 (€135-160)',
    mainEntityType:
      'Kft (Korlátolt Felelősségű Társaság - Limited Liability Company), Rt (Részvénytársaság - Public Limited Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Egyéni Vállalkozó)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for large entities and stock market participants',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Foreign company branch without separate legal personality',
        capitalRequirement: 'None',
        timeline: '3-5 days',
        liability: 'Parent company liable',
        suitableFor: 'Market presence and testing',
  ...
  latvia: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum €2,800 for SIA (Limited Liability Company), €35,000 for AS (Joint Stock Company)',
    registrationFee: 'Approx. €100-150',
    mainEntityType:
      'SIA (Sabiedrība ar Ierobežotu Atbildību - Limited Liability Company), AS (Akciju sabiedrība - Joint Stock Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Individuālais komersants)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'For larger companies, especially those intending to raise capital publicly',
  ...
  lithuania: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'Minimum €2,500 for UAB (Private Limited Company); €40,000 for AB (Public Limited Company)',
    registrationFee: 'Approx. €57-€115',
    mainEntityType:
      'UAB (Uždaroji Akcinė Bendrovė - Private Limited Company), AB (Akcinė Bendrovė - Public Limited Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Individuali Įmonė)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Foreign company extension with no separate legal identity',
        capitalRequirement: 'None',
        timeline: '3-5 days',
        liability: 'Parent company liable',
        suitableFor: 'Market presence and testing',
  ...
  luxembourg: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€12,000 minimum for SARL (Private Limited Company); €31,000 minimum for SA (Public Limited Company)',
    registrationFee:
      'Approx. €400-€1,000 depending on company type and notary fees',
    mainEntityType:
      'SARL (Société à Responsabilité Limitée – Private Limited Company), SA (Société Anonyme – Public Limited Company)',
    secondaryEntityType:
      'Branch Office, Sole Proprietorship (Entrepreneur individuel)',
    benefits: [
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for larger companies, especially those seeking capital market funding',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign parent company with no separate legal identity',
        capitalRequirement: 'None',
        timeline: '2-3 weeks',
        liability: 'Parent company liable',
        suitableFor: 'Market presence and testing',
  ...
  malta: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€1,165 minimum for Ltd (Private Limited Company); approx. €46,600 minimum for PLC (Public Limited Company)',
    registrationFee:
      'Approx. €245-€1,750 depending on company type and share capital',
    mainEntityType:
      'Ltd (Private Limited Company), PLC (Public Limited Company)',
    secondaryEntityType:
      'Partnership, Branch Office, Sole Proprietorship (Sole Trader)',
    benefits: [
    ...
    statistics: {
      ...
      corporateTax:
        'Standard 35% with effective reductions to ~5% through refundable tax credits',
      foreignCompanies:
        'Thousands registered benefiting from favorable tax regime',
      processingDays: '10',
    },
    entityStructures: [
      {
      ...
      },
      {
        ...
        description:
          'Suitable for larger companies requiring capital market access',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Extension of foreign parent company without separate legal identity',
        capitalRequirement: 'None',
        timeline: '1-2 weeks',
        liability: 'Parent company liable',
        suitableFor: 'Market presence and testing',
  ...
  poland: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'PLN 5,000 (~€1,100) minimum for Limited Liability Company (Sp. z o.o); PLN 100,000 (~€22,000) minimum for Joint-Stock Company (S.A)',
    registrationFee:
      'Approx. PLN 600-1,200 depending on company type and registration method',
    mainEntityType:
      'Sp. z o.o (Limited Liability Company), S.A. (Joint-Stock Company)',
    secondaryEntityType:
      'Limited Partnership, Registered Partnership, Sole Proprietorship, Branch Office',
    benefits: [
    ...
    statistics: {
      easeOfBusiness:
        'Growing reputation for efficient registration and business environment',
      corporateTax:
        '19% standard; 9% reduced rate for small taxpayers and start-ups',
      foreignCompanies:
        'Large and growing number, with simplified regulations for EU and non-EU investors',
      processingDays: '14',
    },
    entityStructures: [
      {
      ...
      },
      {
        ...
        description:
          'Suitable for larger enterprises and capital market access',
  ...
  portugal: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€1 minimum for Lda (Private Limited Company); €50,000 minimum for S.A. (Public Limited Company)',
    registrationFee:
      'Approx. €350-€1,000 depending on company type and share capital',
    mainEntityType:
      'Lda (Private Limited Company), S.A. (Public Limited Company)',
    secondaryEntityType:
      'Sole Proprietorship, General Partnership, Limited Partnership, Branch Office',
    benefits: [
    ...
    statistics: {
      easeOfBusiness:
        'Streamlined digital company registration (Empresa na Hora) system',
      corporateTax:
        '21% standard rate; reduced rates for SMEs and regional incentives',
      foreignCompanies:
        'Many registered owing to EU membership and business incentives',
      processingDays: '10',
    },
    entityStructures: [
      {
  ...
  romania: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'RON 1 (~€0.20) minimum for SRL (Limited Liability Company); RON 90,000 (~€18,000) minimum for SA (Joint-Stock Company)',
    registrationFee:
      'Approx. RON 600-1,200 depending on company type and complexity',
    mainEntityType:
      'SRL (Societate cu Răspundere Limitată – Limited Liability Company), SA (Societate pe Acțiuni – Joint-Stock Company)',
    secondaryEntityType:
      'Limited Partnership (SCS), General Partnership (SNC), Sole Proprietorship (PFA), Branch Office',
    benefits: [
    ...
    statistics: {
      easeOfBusiness:
        'Growing business hub with improving registration efficiency',
      corporateTax:
        'Standard 16%; micro-enterprise tax 1%-3% depending on payroll',
    ...
    entityStructures: [
      ...
      },
      {
        ...
        description:
          'Suitable for larger businesses requiring share capital financing',
  ...
  slovakia: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      '€5,000 minimum for Private Limited Liability Company (s.r.o.); minimum €25,000 for Public Limited Company (a.s.)',
    registrationFee: 'Approx. €150 plus legal and notary fees',
    mainEntityType:
      's.r.o. (Private Limited Liability Company), a.s. (Public Limited Company)',
    secondaryEntityType:
      'General Partnership, Limited Partnership, Sole Proprietorship, Branch Office',
    benefits: [
    ...
    statistics: {
      ...
      corporateTax:
        '21% standard; 10% reduced rate for incomes under €100,000 (in 2025)',
      foreignCompanies:
        'Many foreign investors attracted by central location and EU membership',
      processingDays: '7',
    },
    entityStructures: [
      {
        ...
        description: 'Most common form for SMEs and startups',
        capitalRequirement:
          'Minimum capital €5,000 with at least €750 per shareholder paid up',
        timeline: 'Approx. 1 week',
        liability: 'Limited to share capital',
      ...
      },
      {
        ...
        description:
          'Combination of general (unlimited liability) and limited partners',
        capitalRequirement: 'No capital requirement',
        timeline: '1-2 weeks',
        liability: 'Varies by partner type',
      ...
      },
      {
        name: 'Branch Office',
        description:
          'Foreign company extension without separate legal personality',
        capitalRequirement: 'No capital requirement',
        timeline: '1-2 weeks',
        liability: 'Parent company liable',
        suitableFor: 'Market presence and testing',
  ...
  slovenia: {
    ...
    color: '#0056A4',
    processingTime:
      '3-7 days (digital registration), up to 1 week via traditional process',
    complexity: 'Moderate',
    capitalRequirement:
      '€7,500 minimum for d.o.o. (Private Limited Liability Company); €25,000 minimum for d.d. (Public Limited Company)',
    registrationFee:
      'Approx. €200-€400 depending on company type and service method',
    mainEntityType:
      'd.o.o. (Družba z omejeno odgovornostjo – Limited Liability Company), d.d. (Delniška družba – Public Limited Company)',
    secondaryEntityType:
      'Sole Proprietorship (s.p.), General Partnership, Limited Partnership, Branch Office',
    benefits: [
    ...
    statistics: {
      ...
      corporateTax:
        'Standard 22% (temporarily increased from 19% during 2024-2028)',
  ...
  sweden: {
    ...
    complexity: 'Moderate',
    capitalRequirement:
      'SEK 25,000 (~€2,400) for Aktiebolag (AB, Limited Liability Company)',
    registrationFee: 'Approx. SEK 2,200 (~€210)',
    mainEntityType:
      'Aktiebolag (AB), Handelsbolag (Partnership), Enskild Firma (Sole Proprietorship)',
    secondaryEntityType: 'Branch Office',
    benefits: [
...
const DEFAULT_COUNTRY_DATA = {
  ...
  requirements: [
    ...
    'Proof of address for directors',
    'Articles of association',
    'Additional documents vary by country',
  ],
  registrationSteps: [
    'Digital onboarding and KYC verification',
    'Document submission',
    'Legal formalization (varies by country)',
...
const generalFaqs = [
  {
    ...
    answer:
      'Formation times vary by country, typically ranging from 3-5 business days in the Netherlands to 10-15 days in other EU countries. Our expedited services can reduce these timeframes in many jurisdictions.',
  },
  {
    question: 'What are the minimum capital requirements?',
    answer:
      'Capital requirements vary significantly across the EU. Some countries like the Netherlands require as little as €0.01, while others like Germany require €25,000 for a GmbH. Our country selector provides specific information for each jurisdiction.',
  },
  {
    question: 'Do I need to be physically present to form a company?',
    answer:
      'No, our digital-first approach allows you to complete the entire process remotely for all EU countries. We handle all local paperwork and filings on your behalf.',
  },
  {
    question: 'What documents are required?',
    answer:
      'Generally, you will need proof of identity (passport/ID), proof of address, and if applicable, corporate documents of the parent company. Specific requirements vary by country and can be viewed in our detailed country guides.',
  },
  {
    question: 'Can I open a business bank account remotely?',
    answer:
      'Yes, we have partnerships with various EU banks that allow for remote account opening. The process and requirements vary by country and banking institution.',
  },
  {
    question: 'What ongoing compliance requirements will my company have?',
    answer:
      'All EU companies have annual filing requirements, including financial statements and tax returns. Specific requirements vary by country, company type, and size. Our compliance calendar tool helps you track all deadlines.',
  },
];
...
const countryFaqs = {
  netherlands: [
    {
      question:
        'What is the difference between a Legal Entity and a Branch Office?',
      answer:
        'A Legal Entity is a separate legal entity with limited liability protection for shareholders, while a Branch Office is an extension of your existing company without separate legal status. Legal Entities offer better liability protection but have more formal requirements.',
    },
    {
      question: 'How does the Dutch tax system work for companies?',
      answer:
        'The Netherlands has a corporate tax rate of 15% on the first €395,000 of profits and 25.8% on profits exceeding that amount. The country is known for its extensive tax treaty network and favorable holding company regime.',
    },
    {
      question: 'What is the UBO register in the Netherlands?',
      answer:
        'The UBO (Ultimate Beneficial Owner) register requires all Dutch companies to register individuals who ultimately own or control the company (25% or more ownership/voting rights). This information must be registered with the Chamber of Commerce.',
    },
  ],
  germany: [
    {
      question:
        'What are the different business structures available in Germany?',
      answer:
        'Germany offers several business structures: GmbH (most popular, requires €25,000 capital), UG or "mini-GmbH" (can start with €1), AG (public company, requires €50,000), and Branch Offices for foreign companies. Each has different capital requirements and legal obligations.',
    },
    {
      question:
        'What is the complete registration process for a German company?',
      answer:
    ...
    {
      question:
        'What is the difference between Legal Entity and Branch Office in Germany?',
      answer:
        'GmbH/UG/AG are separate legal entities with liability protections; branch offices are part of foreign parent companies with full liability for the parent. Legal entities offer better liability protection but have more formal requirements.',
    },
    {
      question: 'How does the German tax system work for companies?',
      answer:
        'Corporate tax rate is 15% plus 5.5% solidarity surcharge. Municipal trade tax ranges from 7-17%. VAT rate is 19% standard (7% for some goods). Many double tax treaties and R&D tax incentives are available.',
    },
    {
      question: 'What is the UBO register in Germany?',
      answer:
        'All German companies must disclose their Ultimate Beneficial Owners (UBOs)—those with at least 25% shares or voting rights—to the Transparency Register.',
    },
    {
      question:
        'Do I need to be physically present in Germany to form a company?',
      answer:
        'Physical presence is not always required for company formation, but bank account setup may necessitate it. Foreign nationals can own 100% of a German company, and we can provide local nominee directors as a solution while you arrange your residence status.',
    },
    {
      question:
        'What are the ongoing compliance requirements for German companies?',
      answer:
        'German companies must maintain a registered address, comply with corporate and reporting laws, file annual financial statements, pay corporate income tax and trade tax (Gewerbesteuer), and meet employment regulations if hiring. The effective corporate tax rate is approximately 30-33%.',
    },
    {
      question: 'How long does the German company formation process take?',
      answer:
        'The complete process typically takes 10-20 business days (can be 2-3 weeks with complete documents), but delays may occur due to documentation, translation, or banking procedures. Registration fees vary from €500-€2,000 depending on company form and region.',
    },
  ],
  france: [
    {
      question:
        'What are the minimum capital requirements for French companies?',
      answer:
        'SARL/SAS: €1; SA: €37,000 (deposit 1/5th on registration); higher if regulated activity. The minimum capital can be as low as €1 for most business structures.',
    },
    {
      question: 'Is foreign ownership allowed in French companies?',
      answer:
        '100% foreign ownership allowed for SARL, SAS, SA. No local residency required for directors/shareholders. Foreign nationals can fully own and manage French companies.',
    },
    {
      question: 'What is the typical timeline for French company formation?',
      answer:
        '1-4 weeks typical; SARL/SAS often completed in 2 weeks. The process can be faster with complete documentation and proper preparation.',
    },
    {
      question: 'How does the French tax system work for companies?',
      answer:
        'Corporate tax 25%. VAT 20% (reduced rates apply). Dividends: 25% withholding. Various tax incentives for R&D, startups, priority sectors.',
    },
    {
      question: 'What is the UBO register requirement in France?',
      answer:
        'All French entities must declare their UBO (persons with ≥25% share/voting rights), filed with authorities for transparency.',
    },
    {
      question: 'What is the difference between SAS and SARL in France?',
      answer:
        'An SAS (Société par Actions Simplifiée) offers more flexibility in governance and is suitable for companies seeking external investment. A SARL (Société à Responsabilité Limitée) has a more rigid structure but simpler governance, making it suitable for smaller businesses.',
    },
    {
      question: 'What are the requirements for a registered office in France?',
      answer:
        'Every French company must have a physical registered address in France. We offer virtual office services with a prestigious Paris address that fulfills all legal requirements.',
    },
    {
      question: 'How does the French social security system affect employers?',
      answer:
        'French employers must pay substantial social security contributions (approximately 40-45% of gross salary). These cover health insurance, pension, unemployment, and other social benefits for employees.',
    },
  ],
  spain: [
    {
      question:
        'What are the minimum capital requirements for different Spanish entities?',
      answer:
        'SL requires €3,000 minimum; SA requires €60,000, with 25% paid on incorporation. The SL is the most popular choice for small to medium businesses due to its lower capital requirement.',
    },
    {
      question: 'Is foreign ownership allowed in Spanish companies?',
      answer:
        '100% foreign ownership allowed. No residency requirement for directors or shareholders. Foreign nationals can fully own and manage Spanish companies without any local participation requirements.',
    },
    {
      question:
        'What is the typical registration timeline for Spanish companies?',
      answer:
        "SL can be registered within 1-3 weeks, SA may take slightly longer (3-4 weeks). The process is efficient thanks to Spain's electronic registration system (Registro Mercantil Central).",
    },
    {
      question: 'How does the Spanish tax system work for companies?',
      answer:
        'Corporate tax is 25%, but SMEs enjoy reduced rates on first €300,000 profits. Standard VAT rate is 21%. Spain offers various regional grants and R&D incentives for qualifying businesses.',
    },
    {
      question: 'What is the UBO register requirement in Spain?',
      answer:
        'Companies must register Ultimate Beneficial Owners with over 25% ownership or voting rights in the Mercantile Registry for transparency. This is mandatory for all Spanish companies.',
    },
    {
      question: 'What is the difference between SL and SA in Spain?',
      answer:
        'An SL (Sociedad Limitada) requires €3,000 minimum capital and is suitable for small to medium businesses. An SA (Sociedad Anónima) requires €60,000 minimum capital and is designed for larger businesses or those planning to go public.',
    },
    {
      question: 'What is the process for obtaining a NIF in Spain?',
      answer:
        'The NIF (Número de Identificación Fiscal) is the tax identification number for Spanish companies. It starts as provisional when you form your company and becomes permanent once all formation steps are completed. We handle the entire application process.',
    },
    {
      question: 'Are there regional differences in company formation in Spain?',
      answer:
        'Yes, Spain has 17 autonomous communities with varying regional regulations. These can affect aspects like regional taxes, grants, and specific business permits. Our service includes guidance on regional specificities based on your chosen location.',
    },
  ],
  italy: [
    {
      question:
        'What are the minimum capital requirements for SRL and SPA in Italy?',
      answer:
        'SRL can start with €1; SPA requires minimum €50,000 with 25% paid upfront. The SRL is the most popular choice for small to medium businesses due to its lower capital requirement.',
    },
    {
      question: 'Is foreign ownership allowed in Italian companies?',
      answer:
        'No restriction on foreign ownership; directors need not be Italian residents. 100% foreign ownership permitted for all company types including SRL and SPA.',
    },
    {
      question:
        'What is the typical processing time for Italian company formation?',
      answer:
        'Incorporation takes approximately 1 to 3 weeks depending on documents and type. SRL typically takes 1-3 weeks, while SPA may take 2-4 weeks due to higher capital requirements.',
    },
    {
      question: 'How does the Italian tax system work for companies?',
      answer:
        'Corporate tax rate of 24% (IRES), local IRAP tax additional (~3.9%), VAT standard rate 22%. Italy offers tax incentives for innovative startups and SMEs.',
    },
    {
      question: 'What is the UBO register requirement in Italy?',
      answer:
        'Companies must register Ultimate Beneficial Owners in compliance with Italian transparency laws. UBO declaration required for those with ≥25% ownership/voting rights.',
    },
    {
      question: 'What is the difference between SRL and SPA in Italy?',
      answer:
        'SRL (Società a Responsabilità Limitata) is for small to medium businesses with minimum €1 capital. SPA (Società per Azioni) is for larger entities that can issue shares publicly, requiring minimum €50,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Italy?',
      answer:
        'Every Italian company must have a physical registered address in Italy. We offer virtual office services with prestigious Italian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Italian social security system affect employers?',
      answer:
        'Italian employers must register for social security and insurance if employing staff. The system includes health insurance, pension, and other social benefits for employees.',
    },
  ],
  belgium: [
    {
      ...
      answer:
        'BV must have minimum capital of €18,550 with justified start-up capital; NV must have €61,500. The 2019 reform made BV formation more flexible with lower capital thresholds.',
    },
    {
      question: 'Is foreign ownership allowed in Belgian companies?',
      answer:
        'No restrictions on nationality of shareholders or directors; directors can be non-residents. 100% foreign ownership allowed for all company types including BV and NV.',
    },
    {
      question:
        'What is the typical registration timeline for Belgian companies?',
      answer:
        'Business registration can be completed within 5-10 business days typically. BV formation takes 1-2 weeks, while NV may take 2-3 weeks due to higher capital requirements.',
    },
    {
      question: 'How does the Belgian tax system work for companies?',
      answer:
        'Corporate tax standard rate is 25%, with some preferential rates for SMEs and R&D incentives. VAT rate is 21%. Belgium offers various tax incentives for R&D and startups.',
    },
    {
      question: 'What is the UBO register requirement in Belgium?',
      answer:
        'Ultimate Beneficial Owners owning 25%+ must be recorded in UBO Register, accessible to Belgian authorities for transparency. This is mandatory for all Belgian companies.',
    },
    {
      question: 'What is the difference between BV and NV in Belgium?',
      answer:
        'BV (Besloten Vennootschap) is for small to medium businesses with minimum €18,550 capital. NV (Naamloze Vennootschap) is for larger entities that can issue shares publicly, requiring minimum €61,500 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Belgium?',
      answer:
        'Every Belgian company must have a physical registered address in Belgium. We offer virtual office services with prestigious Belgian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Belgian social security system affect employers?',
      answer:
        'Belgian employers must register for social security if hiring employees. The system includes health insurance, pension, and other social benefits for employees.',
    },
  ],
  ireland: [
    {
      ...
      answer:
        'Usually €1 for LTD; €25,000 for PLC (with 25% paid up). The LTD is the most popular choice for small to medium businesses due to its minimal capital requirement.',
    },
    {
      question: 'Can foreigners fully own an Irish company?',
      answer:
        'Yes, 100% foreign ownership is allowed with no local director requirement. No residency requirement for directors or shareholders.',
    },
    {
      question: 'How fast is the Irish company registration process?',
      answer:
        'Typically 3-5 business days online with complete documents. The process is simple and fast through the online Companies Registration Office (CRO) system.',
    },
    {
      question: 'What are the corporate tax rates in Ireland?',
      answer:
        '12.5% standard rate for trading income, 25% for non-trading income. Ireland offers one of the most attractive corporate tax rates in the EU.',
    },
    {
      question: 'What is required for Irish company compliance?',
      answer:
        'Annual returns to CRO, financial statements, and tax filings. Companies must maintain proper records and file annual returns with the Companies Registration Office.',
    },
    {
      question: 'What is the difference between LTD and PLC in Ireland?',
      answer:
        'LTD (Private Company Limited by Shares) is for most business types with minimum €1 capital. PLC (Public Limited Company) is for larger companies seeking to trade publicly, requiring minimum €25,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Ireland?',
      answer:
        'Every Irish company must have a physical registered address in Ireland. We offer virtual office services with prestigious Irish addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Irish employment system work for companies?',
      answer:
        'Irish companies must register for PAYE/PRSI if hiring employees. The system includes social insurance contributions and employment law compliance.',
    },
  ],
  austria: [
    {
      question:
        'What is the minimum capital requirement for Austrian companies?',
      answer:
        'GmbH requires €35,000 with €17,500 minimum paid up; AG requires €70,000 with 25% minimum payment at registration. The GmbH is the most popular choice for small to medium businesses.',
    },
    {
      question: 'Can foreigners fully own Austrian companies?',
      answer:
        'Yes, no restrictions on foreign ownership or nationality of directors. 100% foreign ownership permissible for all company types including GmbH and AG.',
    },
    {
      question: 'How long does Austrian company registration take?',
      answer:
        'Typically 1 to 3 weeks depending on readiness of documentation and payment. GmbH formation takes 1-3 weeks, while AG may take 2-4 weeks due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in Austria?',
      answer:
        'Corporate tax is 25%; local trade tax (Kommunalsteuer) might apply (~3%). VAT is usually 20%. Austria offers favorable tax treaties and R&D incentives.',
    },
    {
      question: 'What is the UBO register requirement in Austria?',
      answer:
        'Disclosure of Ultimate Beneficial Owners owning 25% or more is mandatory, maintained in the Transparency Register. This is required for all Austrian companies.',
    },
    {
      question: 'What is the difference between GmbH and AG in Austria?',
      answer:
        'GmbH (Private Limited Company) is for SMEs and startups with minimum €35,000 capital. AG (Public Limited Company) is for larger companies and stock market participants, requiring minimum €70,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Austria?',
      answer:
        'Every Austrian company must have a physical registered office in Austria. We offer virtual office services with prestigious Austrian addresses that fulfill all legal requirements.',
    },
    {
      question:
        'How does the Austrian social security system affect employers?',
      answer:
        'Austrian companies must register for social security if employing staff. The system includes health insurance, pension, and other social benefits for employees.',
    },
  ],
  bulgaria: [
    {
      question:
        'What is the minimum capital requirement for Bulgarian companies?',
      answer:
        'For OOD, minimum share capital is BGN 2 (~€1). For AD, it is BGN 50,000 (~€25,500). The OOD is the most popular choice due to its minimal capital requirement.',
    },
    {
      question: 'Can foreigners fully own Bulgarian companies?',
      answer:
        'Yes, there are no restrictions on foreign ownership. 100% foreign ownership is permitted for all company types including OOD and AD.',
    },
    {
      question: 'How long does Bulgarian company registration take?',
      answer:
        'Usually 5-10 business days with complete documentation. OOD registration typically takes 5-10 days, while AD may take 10+ days due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in Bulgaria?',
      answer:
        'Flat corporate tax rate of 10% and VAT standard rate at 20%. Bulgaria offers the lowest corporate tax rate in the EU at 10%.',
    },
    {
      question: 'What is the UBO register requirement in Bulgaria?',
      answer:
        'Bulgarian companies must register Ultimate Beneficial Owners with 25% or more ownership or control. This is mandatory for transparency and compliance.',
    },
    {
      question: 'What is the difference between OOD and AD in Bulgaria?',
      answer:
        'OOD (Limited Liability Company) is for SMEs and startups with minimum BGN 2 capital. AD (Joint Stock Company) is for larger enterprises needing to raise capital, requiring minimum BGN 50,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Bulgaria?',
      answer:
        'Every Bulgarian company must have a physical registered office in Bulgaria. We offer virtual office services with prestigious Bulgarian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Bulgarian tax system work for companies?',
      answer:
        'Bulgarian companies must register with the National Revenue Agency for taxes and social security. The system includes VAT registration if threshold exceeded and ongoing tax compliance.',
    },
  ],
  croatia: [
    {
      question:
        'What is the minimum capital requirement for Croatian companies?',
      answer:
        'd.o.o. requires HRK 10,000 minimum (~€1,300); d.d. requires HRK 200,000 (~€26,500). The d.o.o. is the most popular choice for SMEs due to its lower capital requirement.',
    },
    {
      question: 'Can foreigners fully own Croatian companies?',
      answer:
        'Yes, 100% foreign ownership is permitted without restrictions. Full foreign ownership allowed for all company types including d.o.o. and d.d.',
    },
    {
      question: 'How long does Croatian company registration take?',
      answer:
        'Typically 7-14 days for most companies; branches may take slightly less. d.o.o. registration takes 7-14 days, while d.d. may take 14-21 days due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in Croatia?',
      answer:
        'Corporate tax at 18%, VAT standard rate is 25%. Croatia offers a competitive corporate tax rate and access to EU market with increasing FDI incentives.',
    },
    {
      question: 'What is the UBO register requirement in Croatia?',
      answer:
        'Companies must register Ultimate Beneficial Owners (25% or more ownership or control) for transparency purposes. This is mandatory for all Croatian companies.',
    },
    {
      question: 'What is the difference between d.o.o. and d.d. in Croatia?',
      answer:
        'd.o.o. (Limited Liability Company) is for SMEs and startups with minimum HRK 10,000 capital. d.d. (Joint Stock Company) is for larger companies able to raise capital through shares, requiring minimum HRK 200,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Croatia?',
      answer:
        'Every Croatian company must have a physical registered office in Croatia. We offer virtual office services with prestigious Croatian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Croatian tax system work for companies?',
      answer:
        'Croatian companies must register with tax authorities and social security. The system includes VAT registration if applicable and ongoing tax administration and social security obligations.',
    },
  ],
  cyprus: [
    {
      question:
        'What is the minimum capital requirement for Cypriot companies?',
      answer:
        '€1,000 minimum for LTD; €25,629 for PLC. The LTD is the most popular choice for SMEs due to its lower capital requirement and simple structure.',
    },
    {
      question: 'Can foreigners own Cypriot companies entirely?',
      answer:
        'Yes, 100% foreign ownership allowed, no residency needed. Full foreign ownership permitted for all company types with no restrictions on nationality of directors or shareholders.',
    },
    {
      question: 'What is the usual registration timeline?',
      answer:
        'Typically 3-7 working days, faster for simple LTDs. LTD registration takes 3-7 days, while PLC may take 7-14 days due to higher capital requirements.',
    },
    {
      question: 'How does corporate taxation work in Cyprus?',
      answer:
        'Flat 12.5% corporate tax rate, attractive for international businesses. Cyprus offers the lowest corporate tax rate in the EU at 12.5%, making it highly attractive for international business.',
    },
    {
      question: 'Are UBO disclosures mandatory in Cyprus?',
      answer:
        'Yes, beneficial owners holding 25% or more must be registered with authorities. UBO register compliance is mandatory for transparency and anti-money laundering purposes.',
    },
    {
      question: 'What is the difference between LTD and PLC in Cyprus?',
      answer:
        'LTD (Private Limited Company) is for SMEs and startups with minimum €1,000 capital. PLC (Public Limited Company) is for larger businesses seeking public funding, requiring minimum €25,629 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Cyprus?',
      answer:
        'Every Cypriot company must have a physical registered office address in Cyprus. We offer virtual office services with prestigious Cypriot addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Cypriot employment system work for companies?',
      answer:
        'Cypriot companies must register with Social Insurance Services if employing staff. The system includes social insurance contributions and employment law compliance for all employees.',
    },
  ],
  czech: [
    {
      ...
      answer:
        's.r.o. requires CZK 1 (~€40); a.s. requires CZK 2 million (~€80k). The s.r.o. is the most popular choice for SMEs due to its extremely low capital requirement.',
    },
    {
      question: 'Can foreigners fully own Czech companies?',
      answer:
        "No restrictions on foreign ownership or directors' residency. 100% foreign ownership allowed for all company types including s.r.o. and a.s.",
    },
    {
      question: 'How long does Czech company registration take?',
      answer:
        'Usually 7-14 business days, longer for larger a.s. companies. s.r.o. registration takes 7-14 days, while a.s. may take 14-21 days due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in the Czech Republic?',
      answer:
        'Corporate income tax rate at 19%; VAT standard rate 21%. The Czech Republic offers competitive tax rates and access to EU markets with central European economy benefits.',
    },
    {
      question: 'What is the UBO register requirement in the Czech Republic?',
      answer:
        'Mandatory registration of Ultimate Beneficial Owners with significant ownership or control. UBO register compliance is required for persons with ≥25% ownership for transparency purposes.',
    },
    {
      question:
        'What is the difference between s.r.o. and a.s. in the Czech Republic?',
      answer:
        's.r.o. (Limited Liability Company) is for SMEs and startups with minimum CZK 1 capital. a.s. (Joint Stock Company) is for large companies intending to raise capital, requiring minimum CZK 2,000,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in the Czech Republic?',
      answer:
        'Every Czech company must have a physical registered office address in the Czech Republic. We offer virtual office services with prestigious Czech addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Czech employment system work for companies?',
      answer:
        'Czech companies must register with social security and health insurance authorities if employing staff. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  denmark: [
    {
      ...
      answer:
        'DKK 40,000 for ApS; DKK 500,000 for A/S. The ApS is the most popular choice for SMEs due to its lower capital requirement and fast registration process.',
    },
    {
      question: 'Can foreigners fully own Danish companies?',
      answer:
        'Yes, 100% foreign ownership is allowed. No restrictions on foreign ownership for all company types including ApS and A/S.',
    },
    {
      question: 'How fast is Danish company registration?',
      answer:
        'Typically 1-3 business days online for ApS. The Danish system is known for its fast and simple online registration process with robust digital infrastructure.',
    },
    {
      question: 'What are the tax rates in Denmark?',
      answer:
        'Corporate tax at 22%; VAT standard rate 25%. Denmark offers competitive tax rates and access to Nordic and EU markets with a transparent legal system.',
    },
    {
      question: 'Are UBO disclosures required in Denmark?',
      answer:
        'Yes, beneficial owners owning 25% or more must be registered. UBO register compliance is mandatory for transparency and anti-money laundering purposes.',
    },
    {
      question: 'What is the difference between ApS and A/S in Denmark?',
      answer:
        'ApS (Private Limited Company) is for SMEs and startups with minimum DKK 40,000 capital. A/S (Public Limited Company) is for large companies wanting to list shares, requiring minimum DKK 500,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Denmark?',
      answer:
        'Every Danish company must have a physical registered office in Denmark. We offer virtual office services with prestigious Danish addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Danish employment system work for companies?',
      answer:
        'Danish companies must register for labor market and social security if hiring. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  estonia: [
    {
      ...
      answer:
        '€2,500 for OÜ (can be deferred for private companies), €25,000 for AS. The OÜ is the most popular choice for startups due to its flexible capital requirements and fast online registration.',
    },
    {
      question: 'Can foreigners fully own Estonian companies?',
      answer:
        'Yes, 100% foreign ownership is permitted with no local residency required. Estonia offers e-Residency for global entrepreneurs to manage companies remotely.',
    },
    {
      question: 'How fast is Estonian company registration?',
      answer:
        'Typically done within 1-3 business days, fully online. Estonia is renowned for its digital governance and efficient e-Business Register system.',
    },
    {
      question: "What is Estonia's taxation system like?",
      answer:
        'Corporate tax is 20% only on distributed profits; retained profits are tax-exempt. This unique system encourages reinvestment and business growth.',
    },
    {
      question: 'What digital advantages does Estonia offer?',
      answer:
        'Full e-registration via state platform and e-Residency available worldwide. Estonia is a global leader in digital governance with transparent, digitally advanced business environment.',
    },
    {
      question: 'What is the difference between OÜ and AS in Estonia?',
      answer:
        'OÜ (Private Limited Company) is for SMEs and startups with minimum €2,500 capital. AS (Public Limited Company) is for larger companies able to raise capital on stock markets, requiring minimum €25,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Estonia?',
      answer:
        'Every Estonian company must have a registered Estonian address (mandatory). We offer virtual office services with prestigious Estonian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Estonian employment system work for companies?',
      answer:
        'Estonian companies must register social security if employing workers. The system includes comprehensive social security contributions and employment law compliance in a digitally advanced environment.',
    },
  ],
  finland: [
    {
      ...
      answer:
        'For Oy (private limited), minimum share capital is now €1; Oyj requires €80,000. Since 2019, private limited companies no longer have mandatory €2,500 paid-up capital requirement.',
    },
    {
      question: 'Are non-resident directors allowed in Finnish companies?',
      answer:
        'Generally, at least one EEA resident director is required unless a permit is granted. This is a key requirement for Finnish company formation.',
    },
    {
      question: 'How long is the Finnish incorporation process?',
      answer:
        'Typically 3-4 weeks for Oy; longer for public companies. The process varies depending on company type and document readiness, with faster processing for small companies online.',
    },
    {
      question: 'What are the tax rates in Finland?',
      answer:
        'Corporate tax flat at 20%; VAT standard rate 24%. Finland offers competitive tax rates and access to Nordic and European markets with high legal and regulatory transparency.',
    },
    {
      question: 'Can foreign nationals fully own Finnish companies?',
      answer:
        'Yes, there are no restrictions on foreign ownership. 100% foreign ownership is allowed for all company types including Oy and Oyj.',
    },
    {
      question: 'What is the difference between Oy and Oyj in Finland?',
      answer:
        'Oy (Private Limited Company) is for SMEs and startups with minimum €1 capital. Oyj (Public Limited Company) is for larger enterprises listing on stock exchanges, requiring minimum €80,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Finland?',
      answer:
        'Every Finnish company must have a registered Finnish business address. We offer virtual office services with prestigious Finnish addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Finnish employment system work for companies?',
      answer:
        'Finnish companies must register for VAT, tax, and employments as applicable. The system includes comprehensive social security contributions and employment law compliance with strong governmental digital infrastructure.',
    },
  ],
  greece: [
    {
      ...
      answer:
        'IKE requires minimum €4,500, AE requires €25,000. The IKE is the most popular choice for SMEs due to its flexible capital requirements and lower minimum threshold.',
    },
    {
      question: 'Can foreigners fully own Greek companies?',
      answer:
        'Yes, without restriction. 100% foreign ownership is allowed for all company types including IKE and AE, with access to EU single market and strategic Mediterranean location.',
    },
    {
      question: 'How long does Greek company registration take?',
      answer:
        '7-15 business days depending on entity and document readiness. IKE registration takes 7-15 days, while AE may take 14-21 days due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in Greece?',
      answer:
        'Corporate tax at 22%; VAT standard at 24%. Greece offers competitive tax rates and access to EU single market with EU legal protections and transparent corporate governance.',
    },
    {
      question: 'Is UBO disclosure required in Greece?',
      answer:
        'Yes, for owners above 25% beneficial ownership. Ultimate Beneficial Owners registration (UBO) is mandatory for transparency and compliance purposes.',
    },
    {
      question: 'What is the difference between IKE and AE in Greece?',
      answer:
        'IKE (Private Company) is for SMEs and startups with minimum €4,500 capital. AE (Public Limited Company) is for larger companies suited for stock issuance, requiring minimum €25,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Greece?',
      answer:
        'Every Greek company must have a registered Greek business address. We offer virtual office services with prestigious Greek addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Greek employment system work for companies?',
      answer:
        'Greek companies must register employees with social security institutions (EFKA) if hiring. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  hungary: [
    {
      ...
      answer:
        'Kft requires HUF 3 million (~€8,000); Rt requires HUF 5 million (~€13,000). The Kft is the most popular choice for SMEs due to its lower capital requirement and fast registration process.',
    },
    {
      question:
        'Are foreign nationals allowed full ownership of Hungarian companies?',
      answer:
        'Yes, there are no limitations on foreign ownership. 100% foreign ownership is permitted without restrictions for all company types including Kft and Rt.',
    },
    {
      question: 'How long does Hungarian company registration take?',
      answer:
        '3 to 7 days via electronic registration system. Kft registration takes 3-7 days, while Rt may take 7-14 days due to higher capital requirements.',
    },
    {
      question: 'What are the tax rates in Hungary?',
      answer:
        'Corporate tax is 9% flat rate (lowest in EU), VAT is 27% (highest in EU). Hungary offers the lowest corporate tax rate in the EU at 9%, making it highly attractive for international business.',
    },
    {
      question: 'Do companies need to register their UBOs in Hungary?',
      answer:
        'Yes, Ultimate Beneficial Owners with ≥25% ownership must be registered. UBO information registration is mandatory for transparency and compliance purposes.',
    },
    {
      question: 'What is the difference between Kft and Rt in Hungary?',
      answer:
        'Kft (Limited Liability Company) is for SMEs and startups with minimum HUF 3 million capital. Rt (Public Limited Company) is for large entities and stock market participants, requiring minimum HUF 5 million capital.',
    },
    {
      question: 'What are the requirements for a registered office in Hungary?',
      answer:
        'Every Hungarian company must have a registered Hungarian address. We offer virtual office services with prestigious Hungarian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Hungarian employment system work for companies?',
      answer:
        'Hungarian companies must register for tax and social security authority registrations if hiring. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  latvia: [
    {
      question:
        'What is the minimum capital requirement for Latvian companies?',
      answer:
        'SIA requires €2,800 minimum capital; AS requires €35,000. The SIA is the most popular choice for SMEs due to its moderate capital requirements and straightforward registration process.',
    },
    {
      question: 'Are foreigners allowed full ownership of Latvian companies?',
      answer:
        'Yes, full foreign ownership is permitted with no residency requirements. 100% foreign ownership is allowed without restrictions for all company types including SIA and AS.',
    },
    {
      question: 'How quickly is Latvian company registration?',
      answer:
        'Normally 3-7 business days for SIA; longer for AS. Latvia offers a straightforward online registration process via Latvian Company Register with transparent legal framework aligned with EU standards.',
    },
    {
      question: 'What are the tax rates in Latvia?',
      answer:
        'Corporate tax is 20% on distributed profits; VAT at 21%. Latvia offers competitive tax rates and access to EU and Baltic markets with transparent legal framework.',
    },
    {
      question: 'Is UBO disclosure mandatory in Latvia?',
      answer:
        'Yes, UBOs with ≥25% ownership must be registered with authorities. UBO registration is mandatory for beneficial owners with ≥25% ownership for transparency and compliance purposes.',
    },
    {
      question: 'What is the difference between SIA and AS in Latvia?',
      answer:
        'SIA (Limited Liability Company) is for SMEs and entrepreneurs with minimum €2,800 capital. AS (Joint Stock Company) is for larger companies intending to raise capital publicly, requiring minimum €35,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Latvia?',
      answer:
        'Every Latvian company must have a registered Latvian address (mandatory). We offer virtual office services with prestigious Latvian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Latvian employment system work for companies?',
      answer:
        'Latvian companies must register employees with State Social Insurance Agency if hiring. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  lithuania: [
    {
      question:
        'What is the minimum capital requirement for Lithuanian companies?',
      answer:
        'UAB requires €2,500; AB requires €40,000. The UAB is the most popular choice for SMEs due to its moderate capital requirements and fast registration process.',
    },
    {
      question: 'Are foreigners allowed to own 100% of Lithuanian companies?',
      answer:
        'Yes, no restrictions on foreign ownership. 100% foreign ownership is permitted for all company types including UAB and AB.',
    },
    {
      question:
        'What is the typical registration time for Lithuanian companies?',
      answer:
        'Normally 3-5 business days for UAB. Lithuania offers fast and reliable company registration via Lithuanian Centre of Registers with transparent legal and regulatory environment.',
    },
    {
      question: 'What are the corporate tax rates in Lithuania?',
      answer:
        'Corporate income tax at 15%. Lithuania offers competitive tax rates and strategic location in Baltic region with EU market access.',
    },
    {
      question: 'Is UBO disclosure mandatory in Lithuania?',
      answer:
        'Yes, beneficial owners with ≥25% ownership must be registered. UBO registration is mandatory for beneficial owners holding ≥25% for transparency and compliance purposes.',
    },
    {
      question: 'What is the difference between UAB and AB in Lithuania?',
      answer:
        'UAB (Private Limited Company) is for SMEs and startups with minimum €2,500 capital. AB (Public Limited Company) is for larger companies and stock issuance, requiring minimum €40,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Lithuania?',
      answer:
        'Every Lithuanian company must have a registered office address in Lithuania. We offer virtual office services with prestigious Lithuanian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Lithuanian employment system work for companies?',
      answer:
        'Lithuanian companies must register employees with State Social Insurance Fund Board if hiring. The system includes comprehensive social security contributions and employment law compliance.',
    },
  ],
  luxembourg: [
    {
      question:
        'What is the minimum capital requirement for Luxembourg companies?',
      answer:
        'SARL requires €12,000 minimum capital; SA requires €31,000. The SARL is the most popular choice for SMEs due to its lower capital requirement and suitability for family businesses and startups.',
    },
    {
      question: 'Can foreigners fully own Luxembourg companies?',
      answer:
        'Yes, 100% foreign ownership allowed. Luxembourg offers a multilingual business environment (French, German, English) with modern and flexible company laws.',
    },
    {
      question: 'How long does Luxembourg incorporation take?',
      answer:
        'Usually 2-4 weeks depending on documentation and processing. SARL takes 2-4 weeks, while SA may take 3-4 weeks due to higher capital requirements.',
    },
    {
      question: 'What is the corporate tax rate in Luxembourg?',
      answer:
        'Combined rate approx. 24.94%, including municipal business tax. Luxembourg offers an attractive tax regime with extensive double tax treaties network.',
    },
    {
      question: 'Is UBO disclosure mandatory in Luxembourg?',
      answer:
        'Yes, as per EU directives, UBOs must be registered with the Register of Beneficial Owners. UBO registration is mandatory for transparency and compliance with EU transparency directive requirements.',
    },
    {
      question: 'What is the difference between SARL and SA in Luxembourg?',
      answer:
        'SARL (Private Limited Company) is for SMEs and startups with minimum €12,000 capital. SA (Public Limited Company) is for larger companies seeking capital market funding, requiring minimum €31,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Luxembourg?',
      answer:
        'Every Luxembourg company must have a registered Luxembourg business address (mandatory). We offer virtual office services with prestigious Luxembourg addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Luxembourg employment system work for companies?',
      answer:
        'Luxembourg companies must register employees with social security institutions if applicable. The system includes comprehensive social security contributions and employment law compliance in a multilingual business environment.',
    },
  ],
  malta: [
    {
      ...
      answer:
        'Ltd requires €1,165 minimum capital (20% paid up); PLC requires approx. €46,600 (25% paid up). The Ltd is the most popular choice for SMEs due to its lower capital requirement and suitability for family businesses and startups.',
    },
    {
      question: 'Can foreigners fully own Malta companies?',
      answer:
        'Yes, 100% foreign ownership allowed. Malta offers a fully EU-compliant legal and tax framework with strong network of double tax treaties (70+ countries) and strategic location for EU and Mediterranean markets.',
    },
    {
      question: 'How long does Malta incorporation take?',
      answer:
        'Typically 1-2 weeks for Ltd; ~2 weeks for PLC. Malta offers a streamlined registration process favored by investors with business-friendly digital registration and support services.',
    },
    {
      question: 'What is the corporate tax rate in Malta?',
      answer:
        'Standard 35% with effective reductions to ~5% through refundable tax credits. Malta offers government incentives for R&D, IP and innovation, making it attractive for international businesses.',
    },
    {
      question: 'Is UBO disclosure mandatory in Malta?',
      answer:
        'Yes, UBO disclosure is mandatory as per EU transparency requirements. All companies must register their Ultimate Beneficial Owners with the Malta Business Registry for transparency and compliance.',
    },
    {
      question: 'What is the difference between Ltd and PLC in Malta?',
      answer:
        'Ltd (Private Limited Company) is for SMEs and startups with minimum €1,165 capital. PLC (Public Limited Company) is for larger companies requiring capital market access, requiring minimum approx. €46,600 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Malta?',
      answer:
        'Every Malta company must have a registered business address in Malta (mandatory). We offer virtual office services with prestigious Maltese addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Malta employment system work for companies?',
      answer:
        'Malta companies must register employees with social security institutions (Jobs Plus) if applicable. The system includes comprehensive social security contributions and employment law compliance in a business-friendly environment.',
    },
  ],
  poland: [
    {
      ...
      answer:
        'Sp. z o.o requires PLN 5,000 minimum capital; S.A. requires PLN 100,000. The Sp. z o.o is the most popular choice for SMEs due to its lower capital requirement and suitability for startups and family businesses.',
    },
    {
      question: 'Can foreigners fully own Poland companies?',
      answer:
        'Yes, 100% foreign ownership allowed for all entity types. Poland offers a strategic location in Central Europe with access to EU and Eastern markets, competitive corporate tax rates, and a highly skilled workforce.',
    },
    {
      question: 'How long does Poland incorporation take?',
      answer:
        'Usually 1-3 weeks (faster via online S24 portal). Poland has a growing reputation for efficient registration and business environment with modern online company registration portal.',
    },
    {
      question: 'What is the corporate tax rate in Poland?',
      answer:
        '19% standard CIT; 9% for eligible small taxpayers. Poland offers competitive corporate tax rates with reduced rates for small companies and government incentives and special economic zones.',
    },
    {
      question: 'Is UBO disclosure mandatory in Poland?',
      answer:
        'Yes, UBO registration is mandatory as per EU transparency directives. All companies must register their Ultimate Beneficial Owners with the National Court Register (KRS) for transparency and compliance.',
    },
    {
      question: 'What is the difference between Sp. z o.o and S.A. in Poland?',
      answer:
        'Sp. z o.o (Limited Liability Company) is for SMEs and startups with minimum PLN 5,000 capital. S.A. (Joint-Stock Company) is for larger enterprises requiring capital market access, requiring minimum PLN 100,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Poland?',
      answer:
        'Every Poland company must have a registered physical office address in Poland (mandatory). We offer virtual office services with prestigious Polish addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Poland employment system work for companies?',
      answer:
        'Poland companies must register employees with Social Insurance Institution (ZUS) if applicable. The system includes comprehensive social security contributions and employment law compliance in a robust legal framework aligned with EU regulations.',
    },
  ],
  portugal: [
    {
      question:
        'What is the minimum capital requirement for Portugal companies?',
      answer:
        'Lda requires €1 minimum capital; S.A. requires €50,000. The Lda is the most popular choice for SMEs due to its very low capital requirement and suitability for startups and small businesses.',
    },
    {
      question: 'Can foreigners fully own Portugal companies?',
      answer:
        'Yes, 100% foreign ownership allowed. Portugal offers access to the EU market and Portuguese-speaking countries, competitive corporate tax rates with regional incentives, and a strategic location with access to Europe, Africa, and Americas.',
    },
    {
      question: 'How long does Portugal incorporation take?',
      answer:
        'Approx. 2 weeks (faster with Empresa na Hora digital system). Portugal offers streamlined digital company registration with flexible and agile legal framework and government support for startups and innovation.',
    },
    {
      question: 'What is the corporate tax rate in Portugal?',
      answer:
        '21% standard rate; reduced rates for SMEs and regional incentives. Portugal offers competitive corporate tax rates with additional regional tax incentives and government support including Portugal 2030 program.',
    },
    {
      question: 'Is UBO disclosure mandatory in Portugal?',
      answer:
        'Yes, UBO registration is mandatory as per EU transparency laws. All companies must register their Ultimate Beneficial Owners with the Portuguese Commercial Registry for transparency and compliance.',
    },
    {
      question: 'What is the difference between Lda and S.A. in Portugal?',
      answer:
        'Lda (Private Limited Company) is for SMEs and small businesses with minimum €1 capital. S.A. (Public Limited Company) is for larger companies and public offerings, requiring minimum €50,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Portugal?',
      answer:
        'Every Portugal company must have a registered business address in Portugal (mandatory). We offer virtual office services with prestigious Portuguese addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Portugal employment system work for companies?',
      answer:
        'Portugal companies must register employees for social security if applicable. The system includes comprehensive social security contributions and employment law compliance with a multilingual workforce and high quality of life.',
    },
  ],
  romania: [
    {
      question:
        'What is the minimum capital requirement for Romania companies?',
      answer:
        'SRL requires RON 1 minimum capital; SA requires RON 90,000. The SRL is the most popular business form in Romania due to its extremely low capital requirement and suitability for SMEs, startups, and small to medium businesses.',
    },
    {
      question: 'Can foreigners fully own Romania companies?',
      answer:
        'Yes, 100% foreign ownership allowed across all entity types. Romania offers a strategic location bridging Eastern and Western Europe, competitive corporate tax system with incentives for small businesses, and access to EU single market with Schengen membership since 2024.',
    },
    {
      question: 'How long does Romania incorporation take?',
      answer:
        'Usually 1-3 weeks. Romania is a growing business hub with improving registration efficiency, offering a skilled labor force with relatively low operational costs and government incentives supporting technology and innovation sectors.',
    },
    {
      question: 'What is the corporate tax rate in Romania?',
      answer:
        'Standard 16% CIT; 1%-3% for qualifying micro-enterprises depending on payroll. Romania offers competitive corporate tax system with incentives for small businesses and a large number of foreign companies benefiting from EU access and low taxes.',
    },
    {
      question: 'Is UBO disclosure mandatory in Romania?',
      answer:
        'Yes, UBO registration is mandatory under EU law. All companies must register their Ultimate Beneficial Owners with the National Trade Register Office (ONRC) for transparency and compliance with EU transparency rules.',
    },
    {
      question: 'What is the difference between SRL and SA in Romania?',
      answer:
        'SRL (Limited Liability Company) is the most popular business form with minimum RON 1 capital. SA (Joint-Stock Company) is for larger businesses requiring share capital financing, requiring minimum RON 90,000 capital.',
    },
    {
      question: 'What are the requirements for a registered office in Romania?',
      answer:
        'Every Romania company must have a registered physical business address in Romania (mandatory). We offer virtual office services with prestigious Romanian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Romania employment system work for companies?',
      answer:
        'Romania companies must register employees with Social Security (Casa de Asigurări Sociale) if applicable. The system includes comprehensive social security contributions and employment law compliance with a skilled labor force and relatively low operational costs.',
    },
  ],
  slovakia: [
    {
      question:
        'What is the minimum capital requirement for Slovakia companies?',
      answer:
        's.r.o. requires €5,000 minimum capital with at least €750 per shareholder paid up; a.s. requires €25,000. The s.r.o. is the most common form for SMEs and startups due to its lower capital requirement and suitability for small and medium businesses.',
    },
    {
      question: 'Can foreigners fully own Slovakia companies?',
      answer:
        'Yes, 100% foreign ownership allowed. Slovakia offers a strategic Central European location with EU and Schengen access, competitive corporate tax rates with a tiered system, and a highly skilled multilingual workforce at competitive costs.',
    },
    {
      question: 'How long does Slovakia incorporation take?',
      answer:
        'Typically 1 week for s.r.o., 2-3 weeks for a.s. Slovakia offers an efficient registration process with electronic options, active government support for innovation, R&D, and investment incentives, and a robust infrastructure and logistics network.',
    },
    {
      question: 'What is the corporate tax rate in Slovakia?',
      answer:
        '21% standard rate; 10% reduced rate for incomes under €100,000 (in 2025). Slovakia offers competitive corporate tax rates with a tiered system, attracting many foreign investors due to its central location and EU membership.',
    },
    {
      question: 'Is UBO disclosure mandatory in Slovakia?',
      answer:
        'Yes, UBO registration is mandatory per EU guidelines. All companies must register their Ultimate Beneficial Owners with the Commercial Register for transparency and compliance with EU transparency requirements.',
    },
    {
      question: 'What is the difference between s.r.o. and a.s. in Slovakia?',
      answer:
        's.r.o. (Private Limited Liability Company) is for SMEs and startups with minimum €5,000 capital. a.s. (Public Limited Company) is for larger enterprises and public offerings, requiring minimum €25,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Slovakia?',
      answer:
        'Every Slovakia company must have a registered business address in Slovakia (mandatory). We offer virtual office services with prestigious Slovak addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Slovakia employment system work for companies?',
      answer:
        'Slovakia companies must register employees with Social Insurance Agency if applicable. The system includes comprehensive social and health insurance registration with a highly skilled multilingual workforce at competitive costs.',
    },
  ],
  slovenia: [
    {
      question:
        'What is the minimum capital requirement for Slovenia companies?',
      answer:
        'd.o.o. requires €7,500 minimum capital (25% to be paid upfront); d.d. requires €25,000. The d.o.o. is the most common entity for SMEs and startups due to its lower capital requirement and suitability for family businesses and startups.',
    },
    {
      question: 'Can foreigners fully own Slovenia companies?',
      answer:
        'Yes, 100% foreign ownership allowed. Slovenia offers access to EU Single Market and Eurozone, competitive corporate tax rates with government incentives for R&D and startups, and a highly skilled and multilingual workforce.',
    },
    {
      question: 'How long does Slovenia incorporation take?',
      answer:
        '3-7 days electronically via e-VEM portal, longer for traditional processes. Slovenia offers fast electronic registration with a modern digital registration system for efficient incorporation and strong legal framework aligned with EU law.',
    },
    {
      question: 'What is the corporate tax rate in Slovenia?',
      answer:
        'Standard 22% (temporarily increased from 19% during 2024-2028). Slovenia offers competitive corporate tax rates with government incentives for R&D and startups, attracting many foreign companies with 100% foreign ownership allowed.',
    },
    {
      question: 'Is UBO disclosure mandatory in Slovenia?',
      answer:
        'Yes, UBO registration is mandatory under EU law. All companies must register their Ultimate Beneficial Owners with the Slovenian Business Register for transparency and compliance with EU transparency rules.',
    },
    {
      question: 'What is the difference between d.o.o. and d.d. in Slovenia?',
      answer:
        'd.o.o. (Private Limited Company) is for SMEs and startups with minimum €7,500 capital. d.d. (Public Limited Company) is for larger businesses and stock market ventures, requiring minimum €25,000 capital.',
    },
    {
      question:
        'What are the requirements for a registered office in Slovenia?',
      answer:
        'Every Slovenia company must have a registered office address in Slovenia (mandatory). We offer virtual office services with prestigious Slovenian addresses that fulfill all legal requirements.',
    },
    {
      question: 'How does the Slovenia employment system work for companies?',
      answer:
        'Slovenia companies must register employees with social security if applicable. The system includes comprehensive social security contributions and employment law compliance with a highly skilled and multilingual workforce.',
    },
  ],
};
const countries = {
...
export function CompanyFormationPage() {
  ...
  const getCountryData = (countryCode: string) => {
    return (
      COUNTRY_DATA[countryCode as keyof typeof COUNTRY_DATA] || {
  ...
  const getFaqs = (countryCode: string) => {
    return (
      countryFaqs[countryCode as keyof typeof countryFaqs] ||
  ...
  const filteredCountries = Object.entries(countries).filter(([key, name]) =>
    name.toLowerCase().includes(searchQuery.toLowerCase()),
  );
  return (
    <MainLayout>
      <SEO
        title="EU Company Formation Services | House of Companies"
        description="Start and register your EU company effortlessly with House of Companies. Expert guidance, legal compliance, and fast setup across all EU countries."
      />
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            <div className="bg-indigo-900/20 rounded-xl overflow-hidden border border-indigo-500/30">
              ...
              <div className="border-t border-indigo-500/30 bg-indigo-900/30 p-4">
                <SimpleImage
                  imageName="branch_registration_portal.jpg"
                  alt="Company Formation Portal Interface"
            ...
            <div className="bg-indigo-900/20 rounded-xl overflow-hidden border border-indigo-500/30">
              ...
              <div className="border-t border-indigo-500/30 bg-indigo-900/30 p-4">
                <SimpleImage
                  imageName="company_formation_chatbot_demo.jpg"
                  alt="AI Company Formation Agent"
                  className="w-full rounded-lg shadow-lg"
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30">
              ...
              <SimpleImage
                imageName="branch_registration_upload_documents.jpg"
            ...
            <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30">
              ...
              <div className="bg-indigo-900/30 rounded-lg p-4 border border-indigo-500/50">
                <div className="space-y-3">
                  {registrationProgress.steps.slice(0, 3).map((step) => (
                    <div key={step.id} className="flex items-center">
                      {step.completed ? (
                        <div className="h-6 w-6 rounded-full bg-[#EA3A70] flex items-center justify-center mr-3">
                          <CheckIcon className="h-4 w-4 text-white" />
                        </div>
                      ) : (
                        <div className="h-6 w-6 rounded-full border border-indigo-500/50 flex items-center justify-center mr-3">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                className={`bg-[#0F0B1F] rounded-xl p-6 border-2 cursor-pointer transition-colors ${companyType === 'branch' ? 'border-[#EA3A70]' : 'border-[#2D2755] hover:border-[#EA3A70]/50'}`}
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  {companyType === 'branch' && (
                    <div className="bg-[#EA3A70] rounded-full p-1">
                      <CheckIcon className="h-4 w-4 text-white" />
                    </div>
                  )}
                </div>
              ...
              <div
                className={`bg-[#0F0B1F] rounded-xl p-6 border-2 cursor-pointer transition-colors ${companyType === 'entity' ? 'border-[#EA3A70]' : 'border-[#2D2755] hover:border-[#EA3A70]/50'}`}
                onClick={() => setCompanyType('entity')}
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="bg-[#EA3A70]/10 p-3 rounded-lg">
              ...
              <div className="md:col-span-2 mt-4">
                <button
                  onClick={() =>
                    (window.location.href = `/portal/company-formation/${selectedCountry}`)
                  }
                  disabled={!companyType}
                  className={`w-full py-3 rounded-lg font-medium ${companyType ? 'bg-[#EA3A70] text-white hover:bg-[#EA3A70]/90' : 'bg-[#2D2755] text-gray-400 cursor-not-allowed'} transition-colors`}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full bg-indigo-900/20 rounded-xl border border-indigo-500/30">
              ...
              <tbody>
                {currentCountryData.entityStructures.map((entity, index) => (
            ...
            <div className="mb-8">
              ...
              <div className="relative">
                ...
                <div className="space-y-8">
                  {currentCountryData.registrationSteps.map((step, index) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-indigo-900/20 rounded-xl p-6 border border-indigo-500/30">
              ...
              <div className="space-y-4">
                {currentCountryData.requirements.map((requirement, index) => (
            ...
            <div className="border-b border-indigo-500/30 p-4">
              <div className="flex space-x-4">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'overview' ? 'bg-[#EA3A70] text-white' : 'text-indigo-300 hover:bg-indigo-900/30'}`}
                >
                  Overview
                </button>
                <button
                  onClick={() => setActiveTab('order')}
                  className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'order' ? 'bg-[#EA3A70] text-white' : 'text-indigo-300 hover:bg-indigo-900/30'}`}
                >
                  Order Form
                </button>
                <button
                  onClick={() => setActiveTab('progress')}
                  className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'progress' ? 'bg-[#EA3A70] text-white' : 'text-indigo-300 hover:bg-indigo-900/30'}`}
                >
                  Progress Tracking
                </button>
                <button
                  onClick={() => setActiveTab('documents')}
                  className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'documents' ? 'bg-[#EA3A70] text-white' : 'text-indigo-300 hover:bg-indigo-900/30'}`}
                >
                  Documents
                </button>
              </div>
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-indigo-300">
                        {formStep === 1
                          ...
                          : formStep === 2
                            ? 'Choose the country where you want to form your company'
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="md:col-span-2 mt-4">
                        <button
                          ...
                          disabled={!companyType}
                          className={`w-full py-3 rounded-lg font-medium ${companyType ? 'bg-[#EA3A70] text-white hover:bg-[#EA3A70]/90' : 'bg-[#2D2755] text-indigo-400 cursor-not-allowed'} transition-colors`}
                        >
                          Continue
                        </button>
                      </div>
                  ...
                  {formStep === 2 && (
                    <div>
                      <div className="relative mb-6">
                        <div
                          className="flex items-center justify-between p-4 bg-[#0F0B1F] border border-[#2D2755] rounded-lg cursor-pointer"
                          onClick={() =>
                        ...
                        >
                          ...
                          <ChevronDownIcon
                            className={`h-5 w-5 text-indigo-400 transition-transform ${isCountryDropdownOpen ? 'rotate-180' : ''}`}
                          />
                        </div>
                        {isCountryDropdownOpen && (
                          <div className="absolute z-10 mt-1 w-full bg-[#0F0B1F] border border-[#2D2755] rounded-lg shadow-lg max-h-64 overflow-y-auto">
                            <div className="p-2">
                              <div className="relative mb-2">
                                <input
                                  type="text"
                                  placeholder="Search countries..."
                                  className="w-full bg-[#1B1537] border border-[#2D2755] rounded-lg pl-4 pr-4 py-2 text-white focus:outline-none focus:border-[#EA3A70]"
                                  value={searchQuery}
                                  onChange={(e) =>
                              ...
                              <div className="space-y-1">
                                {filteredCountries.map(([key, name]) => (
                                  <div
                                    key={key}
                                    className={`px-3 py-2 rounded-md cursor-pointer ${selectedCountry === key ? 'bg-[#EA3A70] text-white' : 'text-indigo-300 hover:bg-[#2D2755]'}`}
                      ...
                      {selectedCountry && (
                        <div className="bg-[#0F0B1F] border border-[#2D2755] rounded-lg p-6 mb-6">
                          <h3 className="text-xl font-bold text-white mb-4 flex items-center">
                            <span className="bg-[#EA3A70]/10 p-2 rounded-full mr-3">
                              <BuildingIcon className="h-5 w-5 text-[#EA3A70]" />
                            </span>
                            {companyType === 'branch'
                              ? `Branch in ${countries[selectedCountry as keyof typeof countries]}`
                              : `${countries[selectedCountry as keyof typeof countries]} ${currentCountryData.mainEntityType}`}
                          </h3>
                          <div className="space-y-4">
                          ...
                          <div className="mt-6 flex flex-col sm:flex-row gap-4">
                            <button
                              ...
                              className="flex-1 bg-[#EA3A70] text-white py-3 rounded-lg font-medium hover:bg-[#EA3A70]/90 transition-colors"
                            >
                              Continue
                            </button>
                            <button
                              onClick={() => setFormStep(1)}
                              className="flex-1 border border-[#2D2755] text-white py-3 rounded-lg font-medium hover:bg-[#2D2755] transition-colors"
                            >
                              Back
                            </button>
                          </div>
                      ...
                      {!selectedCountry && (
                        <div className="flex justify-end mt-4">
                          <button
                            onClick={() => setFormStep(1)}
                            className="border border-[#2D2755] text-white px-6 py-3 rounded-lg font-medium hover:bg-[#2D2755] transition-colors"
                          >
                            Back
                          </button>
                        </div>
                  ...
                  {formStep === 3 && (
                    <div className="space-y-6">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 mt-6">
                        <Link
                          to={`/portal/company-formation/${selectedCountry}`}
                      ...
                      <div className="mt-4 text-center text-sm text-indigo-400">
                        <p>
                          ...
                          <Link
                            to="/terms"
                            className="text-[#EA3A70] hover:underline"
                          >
                            Terms of Service
                          </Link>{' '}
                          and{' '}
                ...
                <div>
                  <div className="bg-[#0F0B1F] border border-[#2D2755] rounded-lg p-6 mb-8">
                    <div className="flex justify-between items-center mb-6">
                      ...
                      <div
                        className={`px-4 py-2 rounded-full text-sm font-medium ${registrationProgress.status === 'completed' ? 'bg-green-500/20 text-green-500' : registrationProgress.status === 'in-progress' ? 'bg-[#EA3A70]/20 text-[#EA3A70]' : 'bg-yellow-500/20 text-yellow-500'}`}
                      >
                        {registrationProgress.status === 'completed'
                          ? 'Completed'
                          : registrationProgress.status === 'in-progress'
                            ? 'In Progress'
                            : 'Pending'}
                      </div>
                    </div>
                    <div className="relative">
                      ...
                      <div className="space-y-8">
                        {registrationProgress.steps.map((step) => (
                          <div key={step.id} className="relative pl-16">
                            <div
                              className={`absolute left-4 w-5 h-5 rounded-full border-2 ${step.completed ? 'border-[#EA3A70] bg-[#EA3A70]' : 'border-[#2D2755] bg-[#0F0B1F]'}`}
                            />
                            <div
                              className={`bg-[#1B1537] rounded-lg p-4 border ${step.completed ? 'border-[#EA3A70]/30' : 'border-[#2D2755]'}`}
                            >
                              <div className="flex justify-between items-center">
                                <h4
                                  className={`font-medium ${step.completed ? 'text-white' : 'text-indigo-400'}`}
                                >
                                  {step.name}
                                </h4>
                                <span
                                  className={`text-sm ${step.completed ? 'text-[#EA3A70]' : 'text-indigo-400'}`}
                                >
                                  {step.date}
                                </span>
                              </div>
                    ...
                    <div className="bg-[#0F0B1F] border border-[#2D2755] rounded-lg p-6">
                      ...
                      <div className="space-y-4">
                        {documents.map((doc) => (
                          <div
                            key={doc.id}
                            className="flex items-center justify-between p-3 bg-[#1B1537] rounded-lg border border-[#2D2755]"
                          >
                            <div className="flex items-center">
                              <FileTextIcon className="h-5 w-5 text-[#EA3A70] mr-3" />
                              <div>
                            ...
                            {doc.status === 'available' ? (
                              <button className="bg-[#EA3A70] text-white text-sm px-3 py-1 rounded-md flex items-center">
                  ...
                  <div className="bg-[#1B1537] border border-[#2D2755] rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      {currentFaqs.map((faq, index) => (
                        <div
                          key={index}
                          className={`bg-[#0F0B1F] rounded-xl border ${expandedFaq === index ? 'border-[#EA3A70]' : 'border-[#2D2755]'} overflow-hidden transition-all`}
                        >
                          <button
                          ...
                          >
                            ...
                            {expandedFaq === index ? (
                              <ChevronUpIcon className="h-5 w-5 text-[#EA3A70] flex-shrink-0" />
                            ) : (
                              <ChevronDownIcon className="h-5 w-5 text-indigo-400 flex-shrink-0" />
                            )}
                          </button>
                          {expandedFaq === index && (
                            <div className="px-6 pb-4 text-indigo-200">
                              {faq.answer}
                            </div>
                          )}
                        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {currentFaqs.map((faq, index) => (
              <div
                key={index}
                className={`bg-indigo-900/20 rounded-xl border ${expandedFaq === index ? 'border-[#EA3A70]' : 'border-indigo-500/30'} overflow-hidden transition-all`}
              >
                <button
                  className="w-full px-6 py-4 flex items-center justify-between text-left"
                  onClick={() => toggleFaq(index)}
                ...
                {expandedFaq === index && (
                  <div className="px-6 pb-4 text-indigo-200">{faq.answer}</div>
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-gradient-to-b from-[#0F0B1F] to-[#1B1537]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="https://clientdashboard.houseofcompanies.io/"
