...
export function CzechBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Czech tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Czech Commercial Register',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign parent company, not a separate entity',
      subsidiary: 'Separate Czech legal entity, usually an s.r.o. (limited liability company)',
    ...
    },
    {
      ...
      subsidiary: 'Minimum CZK 1 for s.r.o.',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed locally on Czech-sourced income at 19% corporate tax',
      subsidiary: 'Taxed as separate entity on worldwide profits at 19%',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; requires trade license and registration documents',
      subsidiary: 'More complex; requires incorporation with notarial deed, registration with Commercial Register',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Czech regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Czech business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Czech business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Czech branch company?',
      answer:
        'A Czech branch (in Czech: "pobočka" or "odštěpný závod") is not a separate legal entity but an extension of your existing foreign company in the Czech Republic. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in the Czech Republic with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Czech branch vs. a subsidiary?',
      answer:
        'The main advantages of a Czech branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Czech branch?',
      answer:
        'No, a Czech branch does not require a local Czech director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a legal representative in Czechia who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Czech branch perform?',
      answer:
        'A Czech branch can perform all the same activities as a Czech legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Czech branch own property and enter into contracts?',
      answer:
        'Yes, a Czech branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in the Czech Republic?',
      answer:
        "A Czech branch is subject to Czech corporate income tax on profits attributable to its activities in the Czech Republic. The corporate tax rate is 19% on taxable profits. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Czech branch will need to comply with: 1) Annual financial statement filing with the Czech Commercial Register, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Czech business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Czech Republic Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to the Czech Republic with a flexible,
      ...
      {/* What is a Czech Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Czech Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Czech branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Czech branch (in Czech: "pobočka" or "odštěpný závod") is a permanent establishment of a foreign company, not a separate legal entity. It functions as an extension of the parent company, which retains full liability for all debts and obligations incurred by the branch.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Czech branch can perform all the same business activities as a Czech legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct trade and services within the Czech Republic and across the EU',
                  'Enter into contracts and business relationships legally under Czech law',
                  'Own or lease property or other assets',
                  'Employ staff under Czech labor legislation',
                  'Open Czech bank accounts',
              ...
              <p className="text-blue-100">
                The parent company remains fully liable for the branch's activities. Registration requires obtaining a trade license from the local trade office and registration with the Czech Commercial Register. Required documents include notarized corporate documents of the parent, a trade license, proof of registered office, appointment of a legal representative in Czechia, and evidence of non-criminal record for the representative. The branch must submit annual financial statements compliant with Czech accounting standards. It is subject to Czech corporate income tax at 19% on income generated in the country.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in the Czech Republic
              </p>
            </div>
      ...
      {/* About Czech Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Czech Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in the Czech Republic
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Czech Republic\'s 19% corporate tax rate',
                    'Access to Czech Republic\'s highly skilled workforce',
                    'Strategic gateway to Central and Eastern European markets',
                    'Access to Czech Republic\'s advanced infrastructure',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to Central Europe',
                    'Service providers testing the Czech market before full commitment',
                    ...
                    "Startups seeking to leverage Czech Republic's business-friendly environment",
                    'Companies targeting the Central and Eastern European markets',
                    'Manufacturing and industrial businesses',
                    'Organizations requiring access to Czech Republic\'s skilled IT workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Czech branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and trade license preparation
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, trade license application, and Commercial Register submission
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Czech branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Czech branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Czech branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Czech branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Czech branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Czech Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Czech branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Czech business experts on
              WhatsApp:{' '}
            </span>
            <a
