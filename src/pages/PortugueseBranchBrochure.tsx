...
export function PortugueseBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Portuguese tax authorities',
    ...
    },
    {
      ...
      description:
        'File annual financial statements with the Portuguese Commercial Registry',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign company; no independent legal personality',
      subsidiary: 'Separate Portuguese legal entity (e.g., Lda or SA)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable for debts and obligations',
      subsidiary: 'Liability limited to company assets',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirements',
      branch: 'None',
      subsidiary: 'Minimum capital varies: €5,000 for Lda (private limited) or €50,000 for SA (public company)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Portuguese-sourced income; branch profits reported with parent company',
      subsidiary: 'Taxed on worldwide income as independent entity',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Simpler registration process with commercial registry',
      subsidiary: 'More complex incorporation requiring notarized deeds and local compliance',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Portuguese regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Portuguese business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Portuguese business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Portuguese branch company?',
      answer:
        'A Portuguese branch ("filial") is not a separate legal entity but an extension of your existing foreign company in Portugal. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Portugal with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Portuguese branch vs. a subsidiary?',
      answer:
        'The main advantages of a Portuguese branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Portuguese branch?',
      answer:
        'No, a Portuguese branch does not require a local Portuguese director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local legal representative with a Portuguese Tax Identification Number (NIF) who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Portuguese branch perform?',
      answer:
        'A Portuguese branch can perform all the same activities as a Portuguese legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Portuguese branch own property and enter into contracts?',
      answer:
        'Yes, a Portuguese branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Portugal?',
      answer:
        "A Portuguese branch is required to keep accounts in Portugal and pays corporate income tax on profits sourced in Portugal at standard rates (~21%). VAT registration and compliance are mandatory if turnover thresholds are met. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Portuguese branch will need to comply with: 1) Annual financial statement filing with the Portuguese Commercial Registry, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Portuguese business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Portugal Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Portugal with a flexible,
              cost-effective branch structure
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
                to="/portuguese-branch"
      ...
      {/* What is a Portuguese Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Portuguese Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Portuguese branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Portuguese branch ("filial") is a permanent establishment of a foreign company in Portugal and is not a separate legal entity. It acts as an extension of the parent company, which remains fully liable for the branch's obligations and liabilities.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Portuguese branch can perform all the same business activities as a Portuguese legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct business activities permitted to the parent company in Portugal and the EU',
                  'Enter into contracts and form business relationships under Portuguese law',
                  'Own or lease property and assets in Portugal',
                  'Employ staff subject to Portuguese labor regulations',
                  'Open local bank accounts',
                  'Register for VAT and corporate tax purposes',
                  'Apply for necessary licenses and permits',
                  'Engage in public tenders and government contracts',
              ...
              <p className="text-blue-100 mb-6">
                The branch must register with the Portuguese Commercial Registry. Required documents include an apostilled and translated certificate of incorporation of the parent company, articles of association, minutes of the meeting approving the branch establishment, and appointment of a local representative. The branch must have a registered address in Portugal and a local legal representative with Portuguese Tax Identification Number (NIF).
              </p>
              <h3 className="text-2xl font-bold mb-4">Accounting & Taxation</h3>
              <p className="text-blue-100">
                The branch is required to keep accounts in Portugal and submit annual financial statements. It pays corporate income tax on profits sourced in Portugal at standard rates (~21%). VAT registration and compliance are mandatory if turnover thresholds are met.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Portugal
              </p>
            </div>
      ...
      {/* About Portuguese Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Portuguese Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Portugal
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Portugal\'s competitive ~21% corporate tax rate',
                    'Access to Portugal\'s skilled and multilingual workforce',
                    'Strategic gateway to Portuguese-speaking markets (Brazil, Angola, Mozambique)',
                    'Access to Portugal\'s growing tech and innovation ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Companies expanding to Portuguese-speaking markets',
                    'Service providers testing the Portuguese market before full commitment',
                    ...
                    "Startups seeking to leverage Portugal's business-friendly environment",
                    'Companies targeting Portuguese-speaking countries (Brazil, Angola, Mozambique)',
                    'Tech and innovation businesses',
                    'Organizations requiring access to Portugal\'s skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Portuguese branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and Portuguese Commercial Registry registration
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 3-6</div>
              </div>
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                <div className="p-3 bg-indigo-900/50 rounded-lg w-fit mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Portuguese branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Portuguese branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Portuguese branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Portuguese branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Portuguese branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Portuguese Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Portuguese branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Portuguese business experts on
              WhatsApp:{' '}
            </span>
            <a
