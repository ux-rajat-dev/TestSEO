...
export function ItalianBranchBrochure() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0B1F] text-white">
      ...
      <section className="relative py-20 px-4">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="text-2xl font-bold">🇮🇹 Italy</span>
          </div>
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-white to-[#EA3A70] bg-clip-text text-transparent">
            Italy Branch Registration & Management
          </h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Expand your business to Italy with a flexible, cost-effective branch structure
          </p>
      ...
      {/* What is an Italian Branch Section */}
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold mb-4">What is an Italian Branch?</h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              An Italian branch (sede secondaria) is a permanent establishment of a foreign company and is not a separate legal entity. It functions as an extension of the parent company, which retains full liability for the branch's obligations and activities.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <span>Conduct business operations in Italy and throughout the EU</span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                  <span>Enter into contracts and business relationships under Italian law</span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                ...
                <li className="flex items-start">
                  <CheckIcon className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                  <span>Employ staff under Italian employment regulations</span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
                  <span>Open Italian bank accounts for operational needs</span>
                </li>
                <li className="flex items-start">
                  <CheckIcon className="h-6 w-6 text-green-400 mr-3 mt-1 flex-shrink-0" />
            ...
            <div className="bg-[#1A1A2E] rounded-lg p-8">
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  The parent company remains fully liable for the obligations of the Italian branch. Registration requires filing notarized and apostilled documents such as the certificate of incorporation, memorandum and articles of association of the foreign company, and appointing a local representative in Italy.
                </p>
                <p>
                  The branch must be registered with the Italian Business Register (Registro delle Imprese) within 30 days of establishment. All documents must be translated into Italian by a certified translator.
                </p>
                <p>
                  <strong>Taxation:</strong> The branch is taxed on profits generated in Italy at the corporate tax rate of 24%. The branch files separate tax returns for Italian business activities.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              Choose the right structure for your Italian business expansion
            </p>
          </div>
            ...
            <table className="w-full bg-[#0F0B1F] rounded-lg overflow-hidden">
              ...
              <tbody className="text-gray-300">
                <tr className="border-b border-gray-700">
                  ...
                  <td className="px-6 py-4">Separate Italian legal entity (e.g., SRL, SPA)</td>
                </tr>
                <tr className="border-b border-gray-700">
                ...
                <tr className="border-b border-gray-700">
                  ...
                  <td className="px-6 py-4">Taxed on Italian-sourced profits at 24%</td>
                ...
                <tr className="border-b border-gray-700">
                  ...
                  <td className="px-6 py-4">Registration with Business Register; notarized, apostilled documents</td>
                  <td className="px-6 py-4">Incorporation under Italian Civil Code; more complex setup</td>
                </tr>
                <tr>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-[#1A1A2E] rounded-lg p-8 border-2 border-[#EA3A70] relative">
              ...
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-[#EA3A70] mb-2">€1,995</div>
            ...
            <div className="bg-[#1A1A2E] rounded-lg p-8 border border-gray-700">
              <div className="text-center mb-6">
                ...
                <div className="text-4xl font-bold text-[#EA3A70] mb-2">€2,995</div>
      ...
      <section className="py-16 px-4 bg-[#1A1A2E]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              Get your Italian branch up and running quickly
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-2">Business Register</h3>
              <p className="text-gray-400">5-7 days</p>
              <p className="text-sm text-gray-500 mt-2">Official registration with Italian authorities</p>
            </div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              Stay compliant with Italian regulations
            </p>
          </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Annual financial statements in Italian</p>
                  </div>
                </li>
                <li className="flex items-start">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">Italian legal and tax professionals</p>
                  </div>
                </li>
              </ul>
            </div>
      ...
      <section className="py-16 px-4 bg-[#1A1A2E]">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">
              Everything you need to know about Italian branch registration
            </p>
          </div>
          ...
          <div className="space-y-4">
            {[
              {
                question: "How long does it take to register an Italian branch?",
                answer: "The complete registration process typically takes 10-15 business days, including document preparation, translation, and official registration with the Business Register."
              },
              {
                question: "What documents are required for registration?",
                answer: "You'll need the parent company's certificate of incorporation, articles of association, board resolution, and power of attorney for the local representative. All documents must be apostilled and translated into Italian."
              },
              {
                question: "Can I open a bank account for the branch?",
                answer: "Yes, once registered, you can open an Italian bank account. We provide assistance with the bank account opening process and required documentation."
              },
              {
                question: "What are the ongoing compliance requirements?",
                answer: "Italian branches must file annual financial statements, corporate tax returns, and maintain proper accounting records. We handle all compliance requirements for you."
              },
              {
                question: "Is there a minimum capital requirement?",
                answer: "No, there's no minimum capital requirement for establishing an Italian branch. The parent company's capital is considered sufficient."
              },
              {
                question: "Can the branch hire employees?",
                answer: "Yes, Italian branches can hire employees and must comply with Italian labor laws, including social security contributions and employment contracts."
              }
            ].map((faq, index) => (
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Expand to Italy?</h2>
          <p className="text-xl text-gray-300 mb-8">
            Start your Italian branch registration today and access the EU market
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link 
              to="/italian-branch" 
