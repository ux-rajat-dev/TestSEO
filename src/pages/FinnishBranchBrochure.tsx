...
export function FinnishBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Finnish tax authorities',
    ...
    },
    {
      ...
      description:
        'Register parent company\'s financial statements in Finland if they comply with EU regulations',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of the foreign parent company; not a separate legal entity',
      subsidiary: 'Separate Finnish legal entity (most commonly an osakeyhtiö, Ltd)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable for the branch\'s obligations',
    ...
    },
    {
      ...
      subsidiary: 'Minimum share capital €2,500 (typical for Finnish Ltd)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Finnish-sourced income at 20% corporate tax',
      subsidiary: 'Taxed as separate entity on worldwide income at 20%',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; trade register notification, local representative, translated documents needed',
      subsidiary: 'More complex; incorporation with articles of association, registration, board and shareholder requirements',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Finnish regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Finnish business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Finnish business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Finnish branch company?',
      answer:
        'A Finnish branch (sivuliike) is not a separate legal entity but an extension of your existing foreign company in Finland. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Finland with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Finnish branch vs. a subsidiary?',
      answer:
        'The main advantages of a Finnish branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Finnish branch?',
      answer:
        'No, a Finnish branch does not require a local Finnish director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local representative who is a resident of the EEA and authorized to act on behalf of the branch in Finland.',
    },
    {
      question: 'What activities can a Finnish branch perform?',
      answer:
        'A Finnish branch can perform all the same activities as a Finnish legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Finnish branch own property and enter into contracts?',
      answer:
        'Yes, a Finnish branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Finland?',
      answer:
        "A Finnish branch is taxed on income generated in Finland at the corporate tax rate of 20%. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. Losses are generally not recognized separately for tax purposes at the branch level.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Finnish branch will need to comply with: 1) Registering parent company\'s financial statements in Finland if they comply with EU regulations, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Finnish business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Finland Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Finland with a flexible,
      ...
      {/* What is a Finnish Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Finnish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Finnish branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Finnish branch (sivuliike) is a permanent establishment of a foreign parent company and is not a separate legal entity. It is an extension of the parent company, which retains full liability for the branch's obligations and debts.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Finnish branch can perform all the same business activities as a Finnish legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct business and trade in Finland and the wider EU market',
                  'Enter into contracts and operate under Finnish law',
                  'Own or lease assets and property locally',
                  'Employ staff subject to Finnish employment laws',
                  'Open Finnish bank accounts',
                  'Register for VAT and meet tax responsibilities',
                  'Apply for necessary licenses and permits',
                  'Participate in government procurements and contracts',
              ...
              <p className="text-blue-100 mb-6">
                The parent company remains fully liable for all branch activities. The Finnish Trade Register requires notification of the branch opening, including corporate documents from the parent translated into Finnish or Swedish, a local representative (resident of the EEA), and proof of business activities. Non-EEA companies must get a special permit. The branch does not file separate financial statements if the parent's statements comply with EU regulations but must register the parent's financials in Finland.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                A Finnish branch is taxed on income generated in Finland at the corporate tax rate of 20%. Losses are generally not recognized separately for tax purposes at the branch level.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Finland
              </p>
            </div>
      ...
      {/* About Finnish Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Finnish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Finland
              </p>
            </div>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Finland\'s 20% corporate tax rate',
                    'Access to Finland\'s highly educated and tech-savvy workforce',
                    'Strategic gateway to Nordic and Baltic markets',
                    'Access to Finland\'s world-class innovation ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Service providers testing the Finnish market before full commitment',
                    ...
                    "Startups seeking to leverage Finland's business-friendly environment",
                    'Companies targeting the Nordic and Baltic markets',
                    'Green tech and sustainability businesses',
                    'Organizations requiring access to Finland\'s world-class R&D ecosystem',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Finnish branch registration process typically takes 5-7 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document translation, local representative appointment, and Trade Register notification
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Finnish branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              <div className="bg-gradient-to-r from-[#1E1B3F] to-[#0A0826] p-6 text-center">
                ...
                <div className="text-4xl font-bold mb-1">
                  €2,295<span className="text-lg font-normal">/year</span>
                </div>
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Finnish branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Finnish branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Finnish branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Finnish branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Finnish Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Finnish branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Finnish business experts on
              WhatsApp:{' '}
            </span>
            <a
