...
export function SpanishBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Spanish tax authorities',
    ...
    },
    {
      ...
      description:
        'File annual financial statements with the Mercantile Registry',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of parent; not a separate legal entity',
      subsidiary: 'Separate Spanish legal entity (e.g., S.L.)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable for branch obligations',
      subsidiary: 'Liability limited to subsidiary capital',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirement',
      branch: 'None',
      subsidiary: 'Minimum €3,000 capital for S.L.',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Spanish-sourced profits at 24% IRNR rate; branch profit tax of 19% may apply',
      subsidiary: 'Taxed on worldwide income at 25% corporate tax',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Simpler registration with Mercantile Registry',
      subsidiary: 'Full Spanish incorporation process and compliance',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Spanish regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Spanish business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Spanish business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Spanish branch company?',
      answer:
        'A Spanish branch (sucursal) is not a separate legal entity but an extension of your existing foreign company in Spain. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Spain with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Spanish branch vs. a subsidiary?',
      answer:
        'The main advantages of a Spanish branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Spanish branch?',
      answer:
        'No, a Spanish branch does not require a local Spanish director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local representative with a Spanish NIE number who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Spanish branch perform?',
      answer:
        'A Spanish branch can perform all the same activities as a Spanish legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Spanish branch own property and enter into contracts?',
      answer:
        'Yes, a Spanish branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Spain?',
      answer:
        "A Spanish branch is taxed on the profits generated in Spain under Non-Resident Income Tax rules (IRNR) at a flat rate of 24%. Repatriation of profits to the parent may incur a 19% branch profit tax unless mitigated by Double Tax Treaties. The branch files corporate tax returns in Spain and pays VAT on Spanish sales and purchases.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Spanish branch will need to comply with: 1) Annual financial statement filing with the Mercantile Registry, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Spanish business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Spain Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Spain with a flexible,
      ...
      {/* What is a Spanish Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Spanish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Spanish branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Spanish branch (sucursal) is a permanent establishment of a foreign company and is not a separate legal entity. It functions as an extension of the parent company, which holds full liability for the branch's activities, debts, and obligations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Spanish branch can perform all the same business activities as a Spanish legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct business activities allowed to the parent company in Spain and the EU',
                  'Enter into contracts and legal agreements under Spanish law',
                  'Own or lease assets and premises locally',
                  'Employ staff under Spanish labor regulations',
                  'Open Spanish bank accounts for operational purposes',
                  'Register for VAT and corporate taxes with Spanish tax authorities',
              ...
              <p className="text-blue-100 mb-6">
                Registering a branch requires a notarized and apostilled board resolution from the parent company, parent company incorporation certificates, bylaws, and appointment of a local representative with Spanish NIE number. These documents must be translated into Spanish and submitted to the Mercantile Registry. The branch must have a registered office in Spain.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                The branch is taxed on the profits generated in Spain under Non-Resident Income Tax rules (IRNR) at a flat rate of 24%. Repatriation of profits to the parent may incur a 19% branch profit tax unless mitigated by Double Tax Treaties. The branch files corporate tax returns in Spain and pays VAT on Spanish sales and purchases.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Spain
              </p>
            </div>
      ...
      {/* About Spanish Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Spanish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Spain
              </p>
            </div>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Spain\'s competitive 24% IRNR tax rate',
                    'Access to Spain\'s large and skilled workforce',
                    'Strategic gateway to Spanish-speaking markets (Latin America)',
                    'Access to Spain\'s growing tech and tourism ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Service providers testing the Spanish market before full commitment',
                    ...
                    "Startups seeking to leverage Spain's business-friendly environment",
                    'Companies targeting Spanish-speaking countries (Latin America)',
                    'Tourism and hospitality businesses',
                    'Organizations requiring access to Spain\'s skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Spanish branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, apostille, translation, and Mercantile Registry registration
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Spanish branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Spanish branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Spanish branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Spanish branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Spanish branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Spanish Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Spanish branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Spanish business experts on
              WhatsApp:{' '}
            </span>
            <a
