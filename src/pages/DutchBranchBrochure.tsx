...
export function DutchBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Dutch tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Chamber of Commerce',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    ...
    },
    {
      ...
      subsidiary: 'Minimum €0.01 for BV',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Repatriation',
      branch: 'No dividend withholding tax',
      subsidiary: '15% dividend withholding tax (unless reduced by tax treaty)',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Simpler registration process',
      subsidiary: 'More complex incorporation process',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Dutch regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Dutch business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Dutch business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Dutch branch company?',
      answer:
        'A Dutch branch is not a separate legal entity but an extension of your existing foreign company in the Netherlands. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in the Netherlands with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Dutch branch vs. a subsidiary?',
      answer:
        'The main advantages of a Dutch branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Dutch branch?',
      answer:
        'No, a Dutch branch does not require a local Dutch director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a branch representative who is authorized to act on behalf of the branch in the Netherlands.',
    },
    {
      question: 'What activities can a Dutch branch perform?',
      answer:
        'A Dutch branch can perform all the same activities as a Dutch legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Dutch branch own property and enter into contracts?',
      answer:
        'Yes, a Dutch branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in the Netherlands?',
      answer:
        "A Dutch branch is subject to Dutch corporate income tax on profits attributable to its activities in the Netherlands. However, unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. The standard corporate tax rates are 19% on the first €395,000 of taxable profit and 25.8% for profits exceeding this amount.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Dutch branch will need to comply with: 1) Annual financial statement filing with the Dutch Chamber of Commerce, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Dutch business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Dutch Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to the Netherlands with a flexible,
      ...
      {/* What is a Dutch Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Dutch Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Dutch branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Dutch branch (also known as a "bijkantoor" or "filiaal" in
                Dutch) is a permanent establishment of a foreign company in the
                Netherlands. Unlike a subsidiary, a branch is not a separate
                legal entity but an extension of the foreign parent company.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Dutch branch can perform all the same business activities as a
                Dutch legal entity. There are no legal restrictions on the
                operations a branch can conduct compared to a subsidiary. Your
                branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Trade goods and services throughout the EU',
                  'Enter into contracts and business relationships',
                  'Own property and other assets',
                  'Employ staff under Dutch employment law',
                  'Open Dutch bank accounts',
                  'Register for VAT and other tax purposes',
              ...
              <p className="text-blue-100">
                Since a branch is not a separate legal entity, the foreign
                parent company remains fully liable for all obligations, debts,
                and legal issues of the branch. This differs from a subsidiary,
                where liability is generally limited to the subsidiary's assets.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in the
                Netherlands
              </p>
            </div>
      ...
      {/* About Dutch Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Dutch Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in
                the Netherlands
              </p>
            </div>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    "Leverage the Netherlands' extensive tax treaty network",
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Service providers testing the Dutch market before full commitment',
                    ...
                    "Startups seeking to leverage the Netherlands' business-friendly environment",
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Dutch branch registration process typically takes 8-9 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and verification
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 1-4</div>
              </div>
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                <div className="p-3 bg-indigo-900/50 rounded-lg w-fit mb-4">
                ...
                <p className="text-blue-200 mb-3">
                  Document legalization, form preparation, and submission
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 5-7</div>
              </div>
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                <div className="p-3 bg-indigo-900/50 rounded-lg w-fit mb-4">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Dutch branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Dutch branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Dutch branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Dutch branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Dutch branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Dutch Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Dutch branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with Dennis Vermeulen on
              WhatsApp:{' '}
            </span>
            <a
