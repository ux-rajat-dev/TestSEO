...
export function PolishBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Polish tax authorities',
    ...
    },
    {
      ...
      description:
        'File financial statements with the National Court Register (KRS)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign company; no separate entity',
      subsidiary: 'Separate Polish legal entity (e.g., Sp. z o.o.)',
    ...
    },
    {
      ...
      subsidiary: 'Minimum share capital PLN 5,000 (~€1,100)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed locally at 19% on Polish-sourced income',
      subsidiary: 'Taxed as a separate entity on worldwide income',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Simplified registration with KRS',
      subsidiary: 'More formal incorporation procedures, notarization, and filings',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Polish regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Polish business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Polish business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Polish branch company?',
      answer:
        'A Polish branch (oddział) is not a separate legal entity but an extension of your existing foreign company in Poland. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Poland with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Polish branch vs. a subsidiary?',
      answer:
        'The main advantages of a Polish branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Polish branch?',
      answer:
        'No, a Polish branch does not require a local Polish director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local branch representative who must be a resident of Poland and is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Polish branch perform?',
      answer:
        'A Polish branch can perform all the same activities as a Polish legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Polish branch own property and enter into contracts?',
      answer:
        'Yes, a Polish branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Poland?',
      answer:
        "A Polish branch is subject to Polish corporate income tax (CIT) at 19% on income earned in Poland. The branch must maintain separate accounting records and file local tax returns. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Polish branch will need to comply with: 1) Annual financial statement filing with the National Court Register (KRS), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Polish business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Poland Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Poland with a flexible,
      ...
      {/* What is a Polish Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding the Polish branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Polish branch (oddział) is a permanent establishment and organizational unit of a foreign company in Poland, without separate legal personality. It acts as an extension of the parent company, which remains fully liable for the branch's activities and obligations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Polish branch can perform all the same business activities as a Polish legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Carry out trade, services, and business operations in Poland and across the EU',
                  'Enter into contracts and pursue business relationships under Polish law',
                  'Own or lease assets and property locally',
                  'Employ staff under Polish labor law',
                  'Open Polish bank accounts to facilitate operations',
                  'Register for VAT and corporate taxes as required by Polish tax authorities',
                  'Obtain licenses and permits for specific regulated activities',
                  'Participate in government contracts and public tenders',
              ...
              <p className="text-blue-100 mb-6">
                Registration requires a corporate resolution by the parent company, appointment of a local branch representative (must be a resident of Poland), and submission of apostilled, translated constitutional documents (articles of association, certificate of incorporation). The branch must be registered electronically with the National Court Register (KRS). The branch name must contain the parent company's name with "oddział w Polsce" (branch in Poland).
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                The branch is subject to Polish corporate income tax (CIT) at 19% on income earned in Poland. The branch must maintain separate accounting records and file local tax returns.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Poland
              </p>
            </div>
      ...
      {/* About Polish Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Polish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Poland
              </p>
            </div>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Poland\'s competitive 19% corporate tax rate',
                    'Access to Poland\'s large and skilled workforce',
                    'Strategic gateway to Central and Eastern European markets',
                    'Access to Poland\'s growing tech and manufacturing ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Service providers testing the Polish market before full commitment',
                    ...
                    "Startups seeking to leverage Poland's business-friendly environment",
                    'Companies targeting the Central and Eastern European markets',
                    'Manufacturing and industrial businesses',
                    'Organizations requiring access to Poland\'s skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Polish branch registration process typically takes 5-7 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and KRS electronic registration
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Polish branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Polish branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Polish branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Polish branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Polish branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Polish Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Polish branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Polish business experts on
              WhatsApp:{' '}
            </span>
            <a
