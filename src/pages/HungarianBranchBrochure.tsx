...
export function HungarianBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Hungarian tax authorities',
    ...
    },
    {
      ...
      description:
        'File financial statements with Hungary\'s Court of Registration',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign parent company; no separate legal personality',
      subsidiary: 'Separate Hungarian legal entity with limited liability (e.g., Kft)',
    ...
    },
    {
      ...
      subsidiary: 'Minimum capital typically HUF 3 million (~€8,300) for limited liability company (Kft)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Hungarian-sourced income at 9% corporate tax rate',
      subsidiary: 'Taxed as an independent entity on worldwide income',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; filing with Court of Registration and tax authorities',
      subsidiary: 'More complex incorporation involving articles of association and registration',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Hungarian regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Hungarian business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Hungarian business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Hungarian branch company?',
      answer:
        'A Hungarian branch is not a separate legal entity but an extension of your existing foreign company in Hungary. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Hungary with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Hungarian branch vs. a subsidiary?',
      answer:
        'The main advantages of a Hungarian branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Hungarian branch?',
      answer:
        'No, a Hungarian branch does not require a local Hungarian director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a Hungarian resident legal representative who is authorized to act on behalf of the branch in Hungary.',
    },
    {
      question: 'What activities can a Hungarian branch perform?',
      answer:
        'A Hungarian branch can perform all the same activities as a Hungarian legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Hungarian branch own property and enter into contracts?',
      answer:
        'Yes, a Hungarian branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Hungary?',
      answer:
        "A Hungarian branch is taxed similarly to Hungarian companies with a corporate income tax rate of 9%. The branch files separate tax returns for Hungarian business activities, and transfer pricing rules apply due to the international relationship with the parent. This provides excellent tax efficiency compared to many other EU countries.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Hungarian branch will need to comply with: 1) Annual financial statement filing with Hungary\'s Court of Registration, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Hungarian business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Hungary Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Hungary with a flexible,
      ...
      {/* What is a Hungarian Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Hungarian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Hungarian branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Hungarian branch is a permanent establishment of a foreign company and is not a separate legal entity. It acts as an extension of the parent company, which remains fully liable for the branch's obligations and operations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Hungarian branch can perform all the same business activities as a Hungarian legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct trade and provide services in Hungary and across the EU',
                  'Enter contracts and business relationships under Hungarian law',
                  'Own or lease assets such as property and equipment in Hungary',
                  'Employ staff subject to Hungarian labor law and register employees with social security',
                  'Open bank accounts in Hungary',
                  'Register for VAT and other tax obligations following Hungarian regulations',
              ...
              <p className="text-blue-100 mb-6">
                Registration requires filing company documents (apostilled and translated), including the parent company certificate of incorporation, articles of association, and a board resolution to open the branch. The branch must appoint a Hungarian resident legal representative authorized to act on behalf of the branch. The branch name must be identical to the parent company. The branch is registered with Hungary's Court of Registration.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                Branches are taxed similarly to Hungarian companies with a corporate income tax rate of 9%. The branch files separate tax returns for Hungarian business activities, and transfer pricing rules apply due to the international relationship with the parent.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Hungary
              </p>
            </div>
      ...
      {/* About Hungarian Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Hungarian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Hungary
              </p>
            </div>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Hungary\'s extremely low 9% corporate tax rate',
                    'Access to Hungary\'s skilled and cost-effective workforce',
                    'Strategic gateway to Central and Eastern European markets',
                    'Access to Hungary\'s growing tech and innovation ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Service providers testing the Hungarian market before full commitment',
                    'Companies seeking extremely low tax rates in the EU',
                    ...
                    "Startups seeking to leverage Hungary's business-friendly environment",
                    'Companies targeting the Central and Eastern European markets',
                    'Manufacturing and industrial businesses',
                    'Organizations requiring access to Hungary\'s growing tech ecosystem',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Hungarian branch registration process typically takes 5-7 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and Court of Registration filing
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Hungarian branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              <div className="bg-gradient-to-r from-[#1E1B3F] to-[#0A0826] p-6 text-center">
                ...
                <div className="text-4xl font-bold mb-1">
                  €1,995<span className="text-lg font-normal">/year</span>
                </div>
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Hungarian branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Hungarian branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Hungarian branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Hungarian branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Hungarian Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Hungarian branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Hungarian business experts on
              WhatsApp:{' '}
            </span>
            <a
