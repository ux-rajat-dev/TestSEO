...
export function CypriotBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Cypriot tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Cyprus Registrar of Companies',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      ...
      subsidiary: 'Separate Cypriot legal entity, typically a Limited Liability Company (Ltd)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable',
      subsidiary: 'Limited liability for shareholders',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirements',
      branch: 'No minimum capital requirement',
      subsidiary: 'Minimum share capital of €1, typically',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Cyprus-sourced profits if managed in Cyprus; otherwise taxed in parent jurisdiction',
      subsidiary: 'Taxed as domestic company at 12.5% corporate tax',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Registration with Registrar of Companies; notarized, apostilled documents; local representative required',
      subsidiary: 'Incorporation under Cyprus Companies Law; more complex setup and ongoing compliance',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Cypriot regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Cypriot business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Cypriot business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Cypriot branch company?',
      answer:
        'A Cypriot branch is not a separate legal entity but an extension of your existing foreign company in Cyprus. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Cyprus with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Cypriot branch vs. a subsidiary?',
      answer:
        'The main advantages of a Cypriot branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) Flexible tax treatment depending on management location, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Cypriot branch?',
      answer:
        'No, a Cypriot branch does not require a local Cypriot director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local representative in Cyprus who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Cypriot branch perform?',
      answer:
        'A Cypriot branch can perform all the same activities as a Cypriot legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Cypriot branch own property and enter into contracts?',
      answer:
        'Yes, a Cypriot branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Cyprus?',
      answer:
        "A Cypriot branch has flexible tax treatment. If managed outside Cyprus, it's taxed as part of the parent company with no additional tax on profits remitted. If managed and controlled in Cyprus, it's subject to 12.5% corporate tax on locally generated profits. This flexibility allows for strategic tax planning.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Cypriot branch will need to comply with: 1) Annual financial statement filing with the Cyprus Registrar of Companies, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Cypriot business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Cyprus Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Cyprus with a flexible,
      ...
      {/* What is a Cypriot Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Cypriot Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Cypriot branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Cypriot branch is a permanent establishment of a foreign company, not a separate legal entity. It acts as an extension of the parent company, which retains full liability for the branch's activities.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Cypriot branch can perform all the same business activities as a Cypriot legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct business operations in Cyprus and throughout the EU',
                  'Enter into contracts and create business relationships under Cypriot law',
                  'Own or lease property and assets within Cyprus',
                  'Employ staff under Cyprus employment legislation',
              ...
              <p className="text-blue-100 mb-6">
                The parent company remains fully liable for the obligations of the Cypriot branch. Registration requires filing notarized and apostilled documents such as the certificate of incorporation, memorandum and articles of association of the foreign company, and appointing a local representative in Cyprus. The branch must be registered with the Cyprus Registrar of Companies within one month of establishment.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100">
                The branch is taxed as part of the parent company if management is exercised outside Cyprus, with no additional tax on profits remitted to the parent. If managed and controlled in Cyprus, it is subject to corporate tax (12.5%) on profits generated locally. Losses incurred initially may offset taxable profits in the parent company's jurisdiction, subject to local laws.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Cyprus
              </p>
            </div>
      ...
      {/* About Cypriot Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Cypriot Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Cyprus
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Flexible tax treatment based on management location',
                    'Ability to offset initial losses against parent company profits',
                    'Reduced administrative burden',
                    'Full access to the EU single market',
                    'Benefit from Cyprus\'s 12.5% corporate tax rate',
                    'Access to Cyprus\'s English-speaking business environment',
                    'Strategic gateway to Middle East and North Africa',
                    'Access to Cyprus\'s extensive double tax treaty network',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to the Mediterranean region',
                    'Service providers testing the Cypriot market before full commitment',
                    'Companies seeking flexible tax planning opportunities',
                    ...
                    "Startups seeking to leverage Cyprus's business-friendly environment",
                    'Companies targeting the Middle East and North Africa markets',
                    'Organizations requiring access to Cyprus\'s financial services sector',
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Cypriot branch registration process typically takes 5-7 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and preparation for notarization
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, apostille, and Registrar of Companies submission
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Cypriot branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Cypriot branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Cypriot branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Cypriot branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Cypriot branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Cypriot Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Cypriot branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Cypriot business experts on
              WhatsApp:{' '}
            </span>
            <a
