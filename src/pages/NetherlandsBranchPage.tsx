...
import { BuildingIcon, CheckIcon, ArrowRightIcon, MessageSquareIcon, FileTextIcon, SparklesIcon, ClockIcon, ArrowLeftIcon, XIcon, MapPinIcon, ShieldCheckIcon, TrendingUpIcon, UsersIcon, GlobeIcon, CalendarIcon } from 'lucide-react';
...
export function NetherlandsBranchPage() {
  ...
  const pricingTiers = [
    {
      ...
      additionalFee: '€80 KVK registration fee',
  ...
  const timeline = [
    ...
    },
    {
      day: 'Day 2',
      title: 'Official Registration',
      description: 'Filing with Dutch Chamber of Commerce (KVK)'
    },
    {
      day: 'Day 2',
      title: 'Tax Registration',
  ...
  const handleExpertSubmit = (e: React.FormEvent) => {
    ...
    // Show success message with Memo promotion
    alert(`Thank you for your interest! We'll contact you within 24 hours to schedule your consultation.\n\n💡 While you wait, try our AI assistant Memo for instant answers to your questions about Netherlands branch registration!`);
    ...
    <div className="min-h-screen bg-[#0F0B1F]">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              ...
              environments. Your Dutch Branch Office gives your business instant
              credibility in the EU market.
            </p>
      ...
      <section className="py-16 bg-[#1B1537] relative overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://images.unsplash.com/photo-1499856871958-5b9627545d1a?auto=format&fit=crop&q=80)'
          }} 
        />
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12">
      ...
      <section className="py-16 bg-[#1B1537]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">48-Hour Delivery</p>
          </div>
      ...
      <section className="py-16 bg-[#0F0B1F] relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400">
              To register your Dutch branch, you'll need to provide the
              following documents
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="bg-gradient-to-r from-orange-500/10 to-red-500/10 rounded-lg p-8 border border-orange-500/20">
                ...
                <p className="text-gray-300 leading-relaxed">
                  ...
                  straightforward branch registration processes in the EU, with
                  no notary requirements and a fully digital registration
                  system. Our Dutch branch registration service leverages this
                  efficiency to get your business operational quickly and with
                  minimal bureaucracy.
                </p>
              </div>
            </div>
      ...
      <section className="py-16 bg-[#0F0B1F]">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white mb-4">
                Choose Your Path to Netherlands Branch Registration
              </h2>
              <p className="text-gray-400">
                ...
                <div className="bg-[#1B1537] rounded-lg p-6 border border-[#2D2755] max-w-2xl mx-auto">
                  ...
                  {selectedPath === 'memo' && (
                    <div>
                      ...
                      <p className="text-gray-400 mb-6">Get instant tax analysis and personalized recommendations for your Netherlands branch registration.</p>
                      <button 
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#1B1537] rounded-lg max-w-md w-full p-6 border border-[#2D2755]">
            ...
            <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-lg p-4 mb-6">
              ...
              <p className="text-gray-300 text-sm">
                While you wait for your consultation, try our AI assistant <strong>Memo</strong> for instant answers to your Netherlands branch registration questions!
              </p>
            </div>
