...
export function IrishBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Irish tax authorities',
    ...
    },
    {
      ...
      description:
        'File annual returns including financial statements with the Irish Companies Registration Office (CRO)',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of the parent company; no separate legal entity',
      subsidiary: 'Independent Irish company (Ltd), with legal personality',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company liable for all obligations',
    ...
    },
    {
      ...
      subsidiary: 'Minimum share capital of €1 for a Ltd',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Taxation',
      branch: 'Taxed on Irish income at 12.5%, profits taxed in Ireland',
      subsidiary: 'Taxed on worldwide income at 12.5%, as a separate entity',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Faster registration with CRO; documents must be translated and apostilled',
      subsidiary: 'Longer process involving incorporation, including director and secretary requirements',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Irish regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Irish business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Irish business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is an Irish branch company?',
      answer:
        'An Irish branch (Branch Office) is not a separate legal entity but an extension of your existing foreign company in Ireland. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Ireland with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of an Irish branch vs. a subsidiary?',
      answer:
        'The main advantages of an Irish branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Irish branch?',
      answer:
        'No, an Irish branch does not require a local Irish director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local representative or agent who is authorized to accept legal notices and handle compliance in Ireland.',
    },
    {
      question: 'What activities can an Irish branch perform?',
      answer:
        'An Irish branch can perform all the same activities as an Irish legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can an Irish branch own property and enter into contracts?',
      answer:
        'Yes, an Irish branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Ireland?',
      answer:
        "An Irish branch is taxed on Irish-sourced income at Ireland's competitive 12.5% corporate tax rate. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. This provides excellent tax efficiency for international businesses.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Irish branch will need to comply with: 1) Annual returns including financial statements with the Irish Companies Registration Office (CRO), 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Irish business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Ireland Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Ireland with a flexible,
      ...
      {/* What is an Irish Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding the Irish branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                An Irish branch (Branch Office) is a permanent establishment of a foreign company operating in Ireland. It is not a separate legal entity but an extension of the parent company, which retains full liability for all activities and obligations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                An Irish branch can perform all the same business activities as an Irish legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct operations, trade, and services throughout Ireland and the EU',
                  'Enter into contracts and form business relationships under Irish law',
                  'Own or lease property within Ireland',
                  'Employ staff under Irish employment laws and contribute to social security',
                  'Open bank accounts in Ireland to facilitate local transactions',
                  'Register for VAT and corporate taxes following Irish regulations',
                  'Obtain necessary licenses and permits for specific activities',
                  'Participate in public procurement processes and tenders',
              ...
              <p className="text-blue-100">
                Registering a branch requires filing documentation with the Irish Companies Registration Office (CRO). The parent company's documents, such as the certificate of incorporation, memorandum and articles of association, must be apostilled and translated into English if not already in the language. A local representative or agent must be appointed to accept legal notices and handle compliance. The branch must file annual returns, including financial statements, with the CRO, and is taxed on Irish-sourced income at 12.5% corporate tax. It must also adhere to Irish employment and reporting laws.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Ireland
              </p>
            </div>
      ...
      {/* About Irish Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose an Irish Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Ireland
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Ireland\'s competitive 12.5% corporate tax rate',
                    'Access to Ireland\'s highly skilled English-speaking workforce',
                    'Strategic gateway to the UK and EU markets',
                    'Access to Ireland\'s world-class tech and financial services ecosystem',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to the EU market',
                    'Service providers testing the Irish market before full commitment',
                    ...
                    "Startups seeking to leverage Ireland's business-friendly environment",
                    'Companies targeting the UK and EU markets',
                    'Financial services and fintech businesses',
                    'Organizations requiring access to Ireland\'s innovation ecosystem',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Irish branch registration process typically takes 4-6 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document apostille, translation, and CRO registration
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Irish branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Irish branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Irish branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Irish branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Irish branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Irish Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Irish branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Irish business experts on
              WhatsApp:{' '}
            </span>
            <a
