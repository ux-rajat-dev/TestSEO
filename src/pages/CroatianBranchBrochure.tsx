...
export function CroatianBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Croatian tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Croatian Court Register',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      ...
      subsidiary: 'Separate legal entity registered in Croatia (e.g. LLC)',
    ...
    },
    {
      ...
      branch: 'No capital requirement',
      subsidiary: 'Minimum capital varies based on entity type (e.g., HRK 10,000 for LLC)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed locally on Croatian-sourced income',
      subsidiary: 'Taxed as standalone corporate entity on worldwide profits',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; simpler registration and fewer formalities',
      subsidiary: 'More complex; requires full incorporation procedure',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Croatian regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Croatian business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Croatian business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Croatian branch company?',
      answer:
        'A Croatian branch is not a separate legal entity but an extension of your existing foreign company in Croatia. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Croatia with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Croatian branch vs. a subsidiary?',
      answer:
        'The main advantages of a Croatian branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Croatian branch?',
      answer:
        'No, a Croatian branch does not require a local Croatian director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a local legal representative in Croatia who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Croatian branch perform?',
      answer:
        'A Croatian branch can perform all the same activities as a Croatian legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Croatian branch own property and enter into contracts?',
      answer:
        'Yes, a Croatian branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Croatia?',
      answer:
        "A Croatian branch is subject to Croatian corporate income tax on profits attributable to its activities in Croatia. The corporate tax rate is 18% on taxable profits. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Croatian branch will need to comply with: 1) Annual financial statement filing with the Croatian Court Register, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Croatian business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Croatia Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Croatia with a flexible,
      ...
      {/* What is a Croatian Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Croatian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Croatian branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Croatian branch is a permanent establishment of a foreign company, not a separate legal entity. It acts as an extension of the parent company, which remains fully liable for its obligations and debts.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Croatian branch can perform all the same business activities as a Croatian legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Trade goods and services in Croatia and EU markets',
                  'Enter into contracts and business transactions under Croatian law',
                  'Own property or equipment locally',
                  'Employ staff under Croatian labor legislation',
                  'Open Croatian bank accounts',
                  'Register for VAT and fulfill tax requirements',
              ...
              <p className="text-blue-100">
                The parent company holds full liability for the branch's activities. Registration requires notarized documentation from the parent company, translated into Croatian, submitted to the Croatian Court Register and Chamber of Commerce. A local legal representative must be appointed to manage compliance and administrative tasks. The branch must maintain accounting separately but is not considered a separate tax entity.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Croatia
              </p>
            </div>
      ...
      {/* About Croatian Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Croatian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Croatia
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Croatia\'s 18% corporate tax rate',
                    'Access to Croatia\'s skilled and multilingual workforce',
                    'Strategic gateway to Southeast European markets',
                    'Access to Adriatic Sea ports and logistics',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to Southeast Europe',
                    'Service providers testing the Croatian market before full commitment',
                    ...
                    "Startups seeking to leverage Croatia's business-friendly environment",
                    'Companies targeting the Balkan and Southeast European markets',
                    'Organizations requiring access to Adriatic Sea logistics',
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Croatian branch registration process typically takes 7-9 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and Croatian translation
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, Court Register and Chamber of Commerce submission
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Croatian branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Croatian branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Croatian branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Croatian branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Croatian branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Croatian Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Croatian branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Croatian business experts on
              WhatsApp:{' '}
            </span>
            <a
