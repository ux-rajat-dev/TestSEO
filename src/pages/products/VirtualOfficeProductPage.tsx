    ...
    <div className="min-h-screen bg-[#0F0B1F]">
      ...
      <section className="relative pt-20 pb-20 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center bg-gradient-to-r from-indigo-500/10 to-blue-500/10 px-6 py-3 rounded-full text-indigo-400 backdrop-blur-sm mb-8">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6">
              Virtual Office
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-blue-400 to-cyan-400">
                Without the Overhead
              </span>
            </h1>

            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Get a professional business address, mail handling, and phone
              services without the cost of a physical office
            </p>
              ...
              <div className="flex items-center">
                <div className="flex -space-x-2 mr-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-8 h-8 rounded-full bg-gradient-to-br from-indigo-500 to-blue-500 border-2 border-[#0F0B1F]"
                    />
                  ))}
                </div>
                <span className="text-sm">600+ virtual offices active</span>
              </div>
              <div className="flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: 'Meets all registration requirements',
                },
                {
                  icon: <ClockIcon className="h-8 w-8" />,
                  title: '24/7 Access',
                  description: 'Access your mail and services anytime',
                },
                {
                  icon: <GlobeIcon className="h-8 w-8" />,
                  title: 'Multi-Location',
                  description: 'Virtual offices across EU countries',
                },
              ].map((feature, index) => (
                <div
                  key={index}
      ...
      <section className="py-20 bg-gradient-to-r from-[#1B1537] to-[#0F0B1F]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-white mb-4">
              Ready for Your Virtual Office?
            </h2>
            <p className="text-xl text-gray-300 mb-8">
              Set up your professional business presence today
            </p>
            <button
              onClick={handleGetStarted}
