...
export function GermanBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every month with the German tax authorities (Umsatzsteuer)',
      frequency: 'Monthly',
      icon: <PercentIcon className="h-6 w-6 text-blue-600" />,
    },
    {
      title: 'Annual Corporate Income Tax Return',
      description: 'Prepare and submit your annual corporate income tax return (Körperschaftsteuer)',
      frequency: 'Annually',
    ...
    },
    {
      ...
      description:
        'File annual financial statements with the German Commercial Register (Handelsregister)',
      frequency: 'Annually',
      icon: <BarChart3Icon className="h-6 w-6 text-blue-600" />,
    },
    {
      title: 'Annual Trade Tax Return',
      description:
        'File annual trade tax return (Gewerbesteuer) with the local tax office',
      frequency: 'Annually',
      icon: <EuroIcon className="h-6 w-6 text-blue-600" />,
    },
    {
  ...
  const comparisonPoints = [
    {
      aspect: 'Legal Status',
      branch: 'Extension of foreign parent company',
      subsidiary: 'Separate German legal entity (GmbH, UG, AG)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable',
      subsidiary: 'Limited to the subsidiary\'s capital',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirement',
      branch: 'None',
      subsidiary: 'Required based on entity type (e.g., GmbH minimum €25,000)',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Taxation',
      branch: 'Taxed on German profits at ~15% corporate tax + trade tax',
      subsidiary: 'Pays corporate taxes independently',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Faster, less complex registration',
      subsidiary: 'More complex incorporation and compliance',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all German regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about German business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of German business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a German branch company?',
      answer:
        'A German branch (Zweigniederlassung) is not a separate legal entity but an extension of your existing foreign company in Germany. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Germany with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a German branch vs. a subsidiary?',
      answer:
        'The main advantages of a German branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my German branch?',
      answer:
        'No, a German branch does not require a local German director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a branch manager or legal representative authorized to act on behalf of the branch in Germany.',
    },
    {
      question: 'What activities can a German branch perform?',
      answer:
        'A German branch can perform all the same activities as a German legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a German branch own property and enter into contracts?',
      answer:
        'Yes, a German branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Germany?',
      answer:
        "A German branch is taxed on profits generated in Germany. The corporate tax rate is approximately 15% (Körperschaftsteuer), plus trade tax (Gewerbesteuer) which varies by municipality (typically 14-17%). Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company. Social contributions apply to employee wages locally.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your German branch will need to comply with: 1) Annual financial statement filing with the German Commercial Register (Handelsregister), 2) Corporate income tax returns (Körperschaftsteuer), 3) Trade tax returns (Gewerbesteuer), 4) VAT returns (typically monthly), 5) Wage tax returns if you have employees, and 6) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to German business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Germany Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Germany with a flexible,
      ...
      {/* What is a German Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a German Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the German branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A German branch (Zweigniederlassung) is a permanent establishment of a foreign company, not a separate legal entity, acting as an extension of the parent company. The parent company is fully liable for all the branch's contractual obligations and debts.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A German branch can perform all the same business activities as a German legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Operate commercial activities in Germany and throughout the EU',
                  'Enter contracts and business relationships under German law',
                  'Own or lease premises and assets locally',
                  'Employ staff according to German labor regulations',
                  'Open German bank accounts for branch operations',
                  'Register for VAT and corporate tax purposes',
                  'Obtain required permits and licenses',
                  'Bid on public tenders and government contracts',
              ...
              <p className="text-blue-100 mb-6">
                To open a branch in Germany, the foreign company must file notarized and translated documents (Articles of Association, Board resolution, certificate of incorporation) with the German Commercial Register (Handelsregister). A branch manager or legal representative authorized to act on behalf of the branch must be appointed. The branch is assigned a unique registration number and must publish a legal announcement in a German trade publication.
              </p>
              <h3 className="text-2xl font-bold mb-4">Taxation</h3>
              <p className="text-blue-100 mb-6">
                The branch is taxed on profits generated in Germany. The corporate tax rate is approximately 15% (Körperschaftsteuer), plus trade tax (Gewerbesteuer) which varies by municipality (typically 14-17% combined effective rate). Social contributions apply to employee wages locally.
              </p>
              <h3 className="text-2xl font-bold mb-4">Costs</h3>
              <p className="text-blue-100">
                Costs of setting up a branch typically range from €2,000 to €4,000, covering legal, translation, publication, and registration fees.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Germany
              </p>
            </div>
      ...
      {/* About German Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a German Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Germany
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Germany\'s competitive tax rates',
                    'Access to Germany\'s large and sophisticated market',
                    'Strategic gateway to Central and Eastern European markets',
                    'Access to Germany\'s world-class infrastructure and highly skilled workforce',
                  ].map((advantage, index) => (
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Companies expanding to the German market',
                    ...
                    'Organizations targeting Central and Eastern European markets',
                    'Tech companies seeking access to Germany\'s innovation ecosystem',
                    'Businesses requiring access to Germany\'s highly skilled workforce',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, translation, and Commercial Register registration
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 4-7</div>
              </div>
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                <div className="p-3 bg-indigo-900/50 rounded-lg w-fit mb-4">
                ...
                <p className="text-blue-200 mb-3">
                  Legal announcement publication and receipt of registration number
                </p>
                <div className="text-[#EA3A70] font-semibold">Weeks 8-10</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for German branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              <div className="bg-gradient-to-r from-[#1E1B3F] to-[#0A0826] p-6 text-center">
                ...
                <div className="text-4xl font-bold mb-1">
                  €2,495<span className="text-lg font-normal">/year</span>
                </div>
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your German branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your German branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying German branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about German branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your German Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive German branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <button
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our German business experts on
              WhatsApp:{' '}
            </span>
            <a
