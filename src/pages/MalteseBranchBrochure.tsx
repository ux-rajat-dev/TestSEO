...
export function MalteseBranchBrochure() {
  return (
    <div className="min-h-screen bg-[#0F0B1F] text-white">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-red-400 to-white bg-clip-text text-transparent">
            Malta Branch Registration & Management
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Expand your business to Malta with a flexible, cost-effective branch structure
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-red-500 to-white hover:from-red-600 hover:to-gray-200 text-white font-semibold py-3 px-8 rounded-lg transition-all duration-300 transform hover:scale-105">
              Get Started Now →
            </button>
      ...
      {/* What is a Maltese Branch? */}
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-center">What is a Maltese Branch?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800/50 p-8 rounded-lg">
              <p className="text-lg mb-6">
                A Maltese branch is a permanent establishment of a foreign company and is not a separate legal entity. 
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  Conduct business operations in Malta and throughout the EU
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Enter into contracts and business relationships under Maltese law
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Own or lease property and assets within Malta
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Employ staff under Maltese employment legislation
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
            ...
            <div className="bg-gray-800/50 p-8 rounded-lg">
              ...
              <p className="text-gray-300 mb-4">
                The parent company remains fully liable for the obligations of the Maltese branch. Registration requires 
                filing notarized and apostilled documents such as the certificate of incorporation, memorandum and articles 
                of association of the foreign company, and appointing a local representative in Malta.
              </p>
              <p className="text-gray-300 mb-4">
                The branch must be registered with the Malta Business Registry within one month of establishment. 
                All documents must be translated into Maltese or English.
              </p>
              
              <h3 className="text-2xl font-semibold mb-4 text-red-400">Taxation:</h3>
              <p className="text-gray-300">
                The branch is taxed on income generated in Malta at the corporate tax rate of 35%. 
                However, Malta offers various tax incentives and refunds that can significantly reduce the effective tax rate.
              </p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full bg-gray-800/50 rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-700">
                <tr>
                  ...
                  <td className="px-6 py-4 text-gray-300">Separate Maltese legal entity (Ltd)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-gray-300">Minimum share capital of €1,165 for Ltd</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 font-medium">Profit Taxation</td>
                  <td className="px-6 py-4 text-gray-300">Taxed on Maltese-sourced income at 35%</td>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-gray-300">Moderate; registration with Malta Business Registry</td>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-center">Why Choose Malta for Your Branch?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-red-500/20 to-white/20 p-6 rounded-lg border border-red-500/30">
              <h3 className="text-xl font-semibold mb-4 text-red-400">Financial Services Hub</h3>
              <p className="text-gray-300">
                Malta is a leading financial services hub with a robust regulatory framework and expertise in fintech and blockchain.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6 rounded-lg border border-purple-500/30">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">English Language</h3>
              <p className="text-gray-300">
                English is an official language in Malta, making it easier for international businesses to operate.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Translate documents to Maltese/English and apostille</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl font-bold">3</span>
              </div>
              <h3 className="text-lg font-semibold mb-2">Business Registry</h3>
              <p className="text-gray-300 text-sm">Register with Malta Business Registry</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-red-500 rounded-full flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-red-500/20 to-white/20 p-8 rounded-lg border border-red-500/30">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-3 text-gray-300">
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">✓</span>
                    Complete branch registration with Malta Business Registry
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-400 mr-2">✓</span>
              ...
              <div>
                ...
                <div className="text-3xl font-bold text-red-400 mb-2">€1,800</div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-red-400">How long does Maltese branch registration take?</h3>
              <p className="text-gray-300">
                The registration process typically takes 2-3 weeks, including document preparation, translation, and Malta Business Registry filing.
              </p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-red-400">Do I need a local representative in Malta?</h3>
              <p className="text-gray-300">
                Yes, you must appoint a local representative who is a resident of Malta or the EU to handle branch operations and compliance.
              </p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-red-400">What are the ongoing compliance requirements?</h3>
              <p className="text-gray-300">
                The branch must file annual reports, maintain accounting records, and comply with Maltese tax obligations including VAT registration if applicable.
              </p>
            </div>
          </div>
        </div>
