...
export function EstonianBranchBrochure() {
  return (
    <div className="min-h-screen bg-[#0F0B1F] text-white">
      ...
      <section className="relative py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
            Estonia Branch Registration & Management
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Expand your business to Estonia with a flexible, cost-effective branch structure
          </p>
      ...
      {/* What is an Estonian Branch? */}
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-center">What is an Estonian Branch?</h2>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gray-800/50 p-8 rounded-lg">
              <p className="text-lg mb-6">
                An Estonian branch is a permanent establishment of a foreign company and is not a separate legal entity. 
              ...
              <ul className="space-y-3 text-gray-300">
                <li className="flex items-start">
                  ...
                  Conduct business operations in Estonia and throughout the EU
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Enter into contracts and business relationships under Estonian law
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Own or lease property and assets within Estonia
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
                  Employ staff under Estonian employment legislation
                </li>
                <li className="flex items-start">
                  <span className="text-green-400 mr-2">✓</span>
            ...
            <div className="bg-gray-800/50 p-8 rounded-lg">
              ...
              <p className="text-gray-300 mb-4">
                The parent company remains fully liable for the obligations of the Estonian branch. Registration requires 
                filing notarized and apostilled documents such as the certificate of incorporation, memorandum and articles 
                of association of the foreign company, and appointing a local representative in Estonia.
              </p>
              <p className="text-gray-300 mb-4">
                The branch must be registered with the Estonian Commercial Register within one month of establishment. 
                All documents must be translated into Estonian or English.
              </p>
              
              <h3 className="text-2xl font-semibold mb-4 text-blue-400">Taxation:</h3>
              <p className="text-gray-300">
                The branch is taxed on income generated in Estonia at the corporate tax rate of 20%. 
                Estonia has a unique tax system where corporate income tax is only paid on distributed profits, 
                making it attractive for reinvestment.
              </p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full bg-gray-800/50 rounded-lg overflow-hidden">
              ...
              <tbody className="divide-y divide-gray-700">
                <tr>
                  ...
                  <td className="px-6 py-4 text-gray-300">Separate Estonian legal entity (OÜ)</td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td className="px-6 py-4 text-gray-300">Minimum share capital of €2,500 for OÜ</td>
                </tr>
                <tr>
                  <td className="px-6 py-4 font-medium">Profit Taxation</td>
                  <td className="px-6 py-4 text-gray-300">Taxed on Estonian-sourced income at 20%</td>
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold mb-8 text-center">Why Choose Estonia for Your Branch?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-500/20 to-purple-500/20 p-6 rounded-lg border border-blue-500/30">
              <h3 className="text-xl font-semibold mb-4 text-blue-400">Digital Innovation Hub</h3>
              <p className="text-gray-300">
                Estonia is a leading digital nation with advanced e-government services and a business-friendly environment.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 p-6 rounded-lg border border-purple-500/30">
              <h3 className="text-xl font-semibold mb-4 text-purple-400">Competitive Tax System</h3>
              <p className="text-gray-300">
                Unique tax system with 20% corporate tax only on distributed profits, encouraging reinvestment.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Translate documents to Estonian/English and apostille</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-300 text-sm">Register with Estonian Commercial Register</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-500 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-blue-400">How long does Estonian branch registration take?</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-blue-400">Do I need a local representative in Estonia?</h3>
              <p className="text-gray-300">
                Yes, you must appoint a local representative who is a resident of Estonia or the EU to handle branch operations and compliance.
              </p>
            </div>
            <div className="bg-gray-800/50 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-3 text-blue-400">What are the ongoing compliance requirements?</h3>
              <p className="text-gray-300">
                The branch must file annual reports, maintain accounting records, and comply with Estonian tax obligations including VAT registration if applicable.
              </p>
            </div>
          </div>
        </div>
