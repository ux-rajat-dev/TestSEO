...
export function BulgarianBranchBrochure() {
  ...
  const complianceTimeline = [
    {
      ...
      description:
        'File VAT returns every quarter with the Bulgarian tax authorities',
    ...
    },
    {
      ...
      description:
        'Prepare and file your annual financial statements with the Bulgarian Commercial Register',
      frequency: 'Annually',
  ...
  const comparisonPoints = [
    {
      ...
      subsidiary: 'Separate Bulgarian legal entity (e.g., EOOD, OOD)',
      icon: <ScaleIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Liability',
      branch: 'Parent company fully liable',
      subsidiary: 'Limited to subsidiary\'s assets',
      icon: <ShieldCheckIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Capital Requirements',
      branch: 'No minimum capital required',
      subsidiary: 'Minimum capital depends on legal form, e.g., €1 for EOOD',
      icon: <EuroIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Profit Taxation',
      branch: 'Taxed on Bulgarian activities at 10% corporate tax rate',
      subsidiary: 'Taxed on worldwide income at 10% corporate tax',
      icon: <PercentIcon className="h-5 w-5 text-blue-600" />,
    },
    {
      aspect: 'Setup Complexity',
      branch: 'Moderate; registration with Commercial Register, appointment of representative',
      subsidiary: 'Higher; incorporation through notarized deed and registration',
  ...
  const ebranchFeatures = [
    ...
    },
    {
      ...
      description:
        'Automatic reminders and guidance for all Bulgarian regulatory requirements',
      icon: <ShieldCheckIcon className="h-8 w-8 text-blue-600" />,
    },
    {
      title: 'AI Memo Generator',
      description:
        'Get instant answers to your questions about Bulgarian business regulations and compliance',
    ...
    },
    {
      ...
      description:
        'Direct access to our team of Bulgarian business experts via dedicated Slack channel',
  ...
  const faqItems = [
    {
      question: 'What is a Bulgarian branch company?',
      answer:
        'A Bulgarian branch is not a separate legal entity but an extension of your existing foreign company in Bulgaria. It operates under the name and legal responsibility of the parent company but allows you to conduct business activities in Bulgaria with full access to the EU market.',
    },
    {
      question:
        'What are the main advantages of a Bulgarian branch vs. a subsidiary?',
      answer:
        'The main advantages of a Bulgarian branch include: 1) No minimum capital requirements, 2) Simpler and less expensive setup process, 3) No dividend withholding tax on profit repatriation, 4) Possibility to offset initial losses against parent company profits, and 5) Less administrative burden compared to a subsidiary.',
    },
    {
      question: 'Do I need a local director for my Bulgarian branch?',
      answer:
        'No, a Bulgarian branch does not require a local Bulgarian director. Since a branch is not a separate legal entity but an extension of your foreign company, the management structure remains that of the parent company. However, you will need to appoint a legal representative in Bulgaria who is authorized to act on behalf of the branch.',
    },
    {
      question: 'What activities can a Bulgarian branch perform?',
      answer:
        'A Bulgarian branch can perform all the same activities as a Bulgarian legal entity. There are no legal restrictions on the business activities a branch can conduct compared to a subsidiary. This includes trading, service provision, manufacturing, holding assets, employing staff, and entering into contracts.',
    },
    {
      question: 'Can a Bulgarian branch own property and enter into contracts?',
      answer:
        'Yes, a Bulgarian branch can own property, enter into contracts, and conduct all normal business operations. However, legally it is the foreign parent company that owns these assets and is party to these contracts, as the branch is not a separate legal entity.',
    },
    {
      question:
        'What are the tax implications of having a branch in Bulgaria?',
      answer:
        "A Bulgarian branch is subject to Bulgarian corporate income tax on profits attributable to its activities in Bulgaria. The corporate tax rate is 10%, which is one of the lowest in the EU. Unlike a subsidiary, a branch doesn't have separate legal personality, which means there's no dividend withholding tax on profit transfers to the parent company.",
    },
    {
      question: 'What ongoing compliance obligations will my branch have?',
      answer:
        'Your Bulgarian branch will need to comply with: 1) Annual financial statement filing with the Bulgarian Commercial Register, 2) Corporate income tax returns, 3) VAT returns (typically quarterly), 4) Wage tax returns if you have employees, and 5) Various industry-specific regulatory requirements depending on your business activities.',
    },
    {
      question: 'How does the eBranch platform simplify branch management?',
      answer:
        'The eBranch platform streamlines branch management by: 1) Digitalizing all incoming mail through our virtual office service, 2) Providing AI-powered document management and data extraction, 3) Automating compliance reminders and form preparation, 4) Offering self-serve tools for tax filing and financial reporting, and 5) Giving you direct access to Bulgarian business experts via a dedicated Slack channel for any questions that arise.',
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-[#0A0826] text-white">
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
              Bulgaria Branch Registration & Management
            </h1>
            <p className="text-xl mb-8 text-blue-100">
              Expand your business to Bulgaria with a flexible,
      ...
      {/* What is a Bulgarian Branch Section */}
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                What is a Bulgarian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                Understanding the Bulgarian branch structure and how it works
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-8 border border-indigo-500/30 mb-8">
              ...
              <p className="text-blue-100 mb-6">
                A Bulgarian branch is a permanent establishment of a foreign company and is not recognized as a separate legal entity. It operates as an extension of the parent company, which retains full liability for the branch's obligations.
              </p>
              <h3 className="text-2xl font-bold mb-4">Business Capabilities</h3>
              <p className="text-blue-100 mb-6">
                A Bulgarian branch can perform all the same business activities as a Bulgarian legal entity. There are no legal restrictions on the operations a branch can conduct compared to a subsidiary. Your branch can:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                {[
                  'Conduct trade and services throughout Bulgaria and the EU',
                  'Enter contracts and business relationships legally under Bulgarian law',
                  'Own assets such as property or equipment in Bulgaria',
                  'Employ personnel under Bulgarian employment laws',
                  'Open Bulgarian bank accounts for operations',
                  'Register for VAT and other relevant taxes once turnover exceeds thresholds',
              ...
              <p className="text-blue-100">
                The parent company remains fully liable for the Bulgarian branch's debts and responsibilities. Registration requires notarized and apostilled parent company documents translated into Bulgarian. The branch must appoint a legal representative in Bulgaria and register with the Bulgarian Commercial Register. The branch maintains its own accounting but is not a separate tax entity from the parent, paying corporate income tax on Bulgarian-sourced profits.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Understanding your options for establishing a presence in Bulgaria
              </p>
            </div>
      ...
      {/* About Bulgarian Branch Section */}
      <section className="py-16 bg-gradient-to-r from-[#1E1B3F] to-[#0A0826]">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-200">
                Why Choose a Bulgarian Branch?
              </h2>
              <p className="text-xl text-blue-100">
                A cost-effective and flexible way to establish your presence in Bulgaria
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    ...
                    'Benefit from Bulgaria\'s 10% corporate tax rate (lowest in EU)',
                    'Access to Bulgaria\'s cost-effective and skilled workforce',
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <ul className="space-y-3">
                  {[
                    'Tech companies expanding to Eastern Europe',
                    'Service providers testing the Bulgarian market before full commitment',
                    ...
                    "Startups seeking to leverage Bulgaria's business-friendly environment",
                    'Companies targeting the Balkan and Eastern European markets',
                    'Organizations requiring cost-effective EU operations',
                  ].map((ideal, index) => (
                    <li key={index} className="flex items-start">
                      <CheckCircleIcon className="h-5 w-5 text-[#EA3A70] mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100 mb-6">
                The Bulgarian branch registration process typically takes 6-8 weeks
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Initial consultation, document collection, and Bulgarian translation
                </p>
              ...
              <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl p-6 border border-indigo-500/30">
                ...
                <p className="text-blue-200 mb-3">
                  Document notarization, apostille, and Commercial Register submission
                </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                A comprehensive solution for Bulgarian branch registration and
                management
              </p>
            </div>
            <div className="bg-[#1E1B3F]/70 backdrop-blur-sm rounded-xl overflow-hidden shadow-xl border border-indigo-500/30">
              <div className="bg-gradient-to-r from-[#1E1B3F] to-[#0A0826] p-6 text-center">
                ...
                <div className="text-4xl font-bold mb-1">
                  €1,895<span className="text-lg font-normal">/year</span>
                </div>
              ...
              <div className="p-6 md:p-8">
                <p className="text-blue-100 mb-6">
                  ...
                  manage your Bulgarian branch, including registration services,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Key compliance requirements for your Bulgarian branch after
                formation
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Simplifying Bulgarian branch management with cutting-edge technology
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-100">
                Common questions about Bulgarian branch registration and management
              </p>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold mb-4">
              Ready to Establish Your Bulgarian Branch?
            </h2>
            <p className="text-xl mb-8 text-blue-100">
              Get started with our comprehensive Bulgarian branch registration and
              management solution
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link
      ...
      <div className="bg-green-500 text-white py-3">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-center">
            ...
            <span>
              Have questions? Chat directly with our Bulgarian business experts on
              WhatsApp:{' '}
            </span>
            <a
